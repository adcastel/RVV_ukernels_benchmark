...
//     C : [f16][8, 96] @DRAM
// )
void gemm_RVV_96x8_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, struct exo_win_2f16c A, struct exo_win_2f16c B, const float* beta, struct exo_win_2f16 C ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_5 = __riscv_vfmacc_vf_f16m1(C_reg_0_5, B.data[(k) * (B.strides[0])], A_reg_5,(16));
  ...
  C_reg_1_5 = __riscv_vfmacc_vf_f16m1(C_reg_1_5, B.data[(k) * (B.strides[0]) + 1], A_reg_5,(16));
  ...
  C_reg_2_4 = __riscv_vfmacc_vf_f16m1(C_reg_2_4, B.data[(k) * (B.strides[0]) + 2], A_reg_4,(16));
  C_reg_2_5 = __riscv_vfmacc_vf_f16m1(C_reg_2_5, B.data[(k) * (B.strides[0]) + 2], A_reg_5,(16));
  ...
  C_reg_3_4 = __riscv_vfmacc_vf_f16m1(C_reg_3_4, B.data[(k) * (B.strides[0]) + 3], A_reg_4,(16));
  C_reg_3_5 = __riscv_vfmacc_vf_f16m1(C_reg_3_5, B.data[(k) * (B.strides[0]) + 3], A_reg_5,(16));
  ...
  C_reg_4_4 = __riscv_vfmacc_vf_f16m1(C_reg_4_4, B.data[(k) * (B.strides[0]) + 4], A_reg_4,(16));
  C_reg_4_5 = __riscv_vfmacc_vf_f16m1(C_reg_4_5, B.data[(k) * (B.strides[0]) + 4], A_reg_5,(16));
  ...
  C_reg_5_4 = __riscv_vfmacc_vf_f16m1(C_reg_5_4, B.data[(k) * (B.strides[0]) + 5], A_reg_4,(16));
  C_reg_5_5 = __riscv_vfmacc_vf_f16m1(C_reg_5_5, B.data[(k) * (B.strides[0]) + 5], A_reg_5,(16));
  ...
  C_reg_6_4 = __riscv_vfmacc_vf_f16m1(C_reg_6_4, B.data[(k) * (B.strides[0]) + 6], A_reg_4,(16));
  C_reg_6_5 = __riscv_vfmacc_vf_f16m1(C_reg_6_5, B.data[(k) * (B.strides[0]) + 6], A_reg_5,(16));
  ...
  C_reg_7_4 = __riscv_vfmacc_vf_f16m1(C_reg_7_4, B.data[(k) * (B.strides[0]) + 7], A_reg_4,(16));
  C_reg_7_5 = __riscv_vfmacc_vf_f16m1(C_reg_7_5, B.data[(k) * (B.strides[0]) + 7], A_reg_5,(16));
}
...
__riscv_vse16_v_f16m1(&C.data[(2) * (C.strides[0]) + 64], C_reg_2_4,(16));
__riscv_vse16_v_f16m1(&C.data[(2) * (C.strides[0]) + 80], C_reg_2_5,(16));
...
__riscv_vse16_v_f16m1(&C.data[(3) * (C.strides[0]) + 64], C_reg_3_4,(16));
__riscv_vse16_v_f16m1(&C.data[(3) * (C.strides[0]) + 80], C_reg_3_5,(16));
...
__riscv_vse16_v_f16m1(&C.data[(4) * (C.strides[0]) + 64], C_reg_4_4,(16));
__riscv_vse16_v_f16m1(&C.data[(4) * (C.strides[0]) + 80], C_reg_4_5,(16));
...
__riscv_vse16_v_f16m1(&C.data[(5) * (C.strides[0]) + 64], C_reg_5_4,(16));
__riscv_vse16_v_f16m1(&C.data[(5) * (C.strides[0]) + 80], C_reg_5_5,(16));
...
__riscv_vse16_v_f16m1(&C.data[(6) * (C.strides[0]) + 64], C_reg_6_4,(16));
__riscv_vse16_v_f16m1(&C.data[(6) * (C.strides[0]) + 80], C_reg_6_5,(16));
...
__riscv_vse16_v_f16m1(&C.data[(7) * (C.strides[0]) + 64], C_reg_7_4,(16));
__riscv_vse16_v_f16m1(&C.data[(7) * (C.strides[0]) + 80], C_reg_7_5,(16));
}
...
//     C : [f16][8, 96] @DRAM
// )
void gemm_RVV_96x8_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, struct exo_win_2f16c A, struct exo_win_2f16c B, const float* beta, struct exo_win_2f16 C ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
...
C_reg_2_4 = __riscv_vle16_v_f16m1(&C.data[(2) * (C.strides[0]) + 64],(16));
C_reg_2_5 = __riscv_vle16_v_f16m1(&C.data[(2) * (C.strides[0]) + 80],(16));
...
C_reg_3_4 = __riscv_vle16_v_f16m1(&C.data[(3) * (C.strides[0]) + 64],(16));
C_reg_3_5 = __riscv_vle16_v_f16m1(&C.data[(3) * (C.strides[0]) + 80],(16));
...
C_reg_4_4 = __riscv_vle16_v_f16m1(&C.data[(4) * (C.strides[0]) + 64],(16));
C_reg_4_5 = __riscv_vle16_v_f16m1(&C.data[(4) * (C.strides[0]) + 80],(16));
...
C_reg_5_4 = __riscv_vle16_v_f16m1(&C.data[(5) * (C.strides[0]) + 64],(16));
C_reg_5_5 = __riscv_vle16_v_f16m1(&C.data[(5) * (C.strides[0]) + 80],(16));
...
C_reg_6_4 = __riscv_vle16_v_f16m1(&C.data[(6) * (C.strides[0]) + 64],(16));
C_reg_6_5 = __riscv_vle16_v_f16m1(&C.data[(6) * (C.strides[0]) + 80],(16));
...
C_reg_7_4 = __riscv_vle16_v_f16m1(&C.data[(7) * (C.strides[0]) + 64],(16));
C_reg_7_5 = __riscv_vle16_v_f16m1(&C.data[(7) * (C.strides[0]) + 80],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0])],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0]) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0]) + 32],(16));
