...
//     C : [f16][14, 64] @DRAM
// )
void gemm_RVV_64x14_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, struct exo_win_2f16c A, struct exo_win_2f16c B, const float* beta, struct exo_win_2f16 C ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_12_3 = __riscv_vfmacc_vf_f16m1(C_reg_12_3, B.data[(k) * (B.strides[0]) + 12], A_reg_3,(16));
  ...
  C_reg_13_3 = __riscv_vfmacc_vf_f16m1(C_reg_13_3, B.data[(k) * (B.strides[0]) + 13], A_reg_3,(16));
}
...
__riscv_vse16_v_f16m1(&C.data[(12) * (C.strides[0]) + 48], C_reg_12_3,(16));
...
__riscv_vse16_v_f16m1(&C.data[(13) * (C.strides[0]) + 48], C_reg_13_3,(16));
}
...
//     C : [f16][14, 64] @DRAM
// )
void gemm_RVV_64x14_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, struct exo_win_2f16c A, struct exo_win_2f16c B, const float* beta, struct exo_win_2f16 C ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
...
C_reg_12_3 = __riscv_vle16_v_f16m1(&C.data[(12) * (C.strides[0]) + 48],(16));
...
C_reg_13_3 = __riscv_vle16_v_f16m1(&C.data[(13) * (C.strides[0]) + 48],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0])],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0]) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A.data[(k) * (A.strides[0]) + 32],(16));
