...
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(8));
  ...
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 1) * (16)],(8));
  ...
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vv_f32m1(C_regt_0, A_regt, B_reg_0,(2));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 2) * (16)],(8));
  ...
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_regt_0 = __riscv_vfmacc_vv_f32m1(C_regt_0, A_regt, B_reg_0,(2));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 3) * (16)],(8));
...
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
...
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  A_regt = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16) + 8],(4));
...
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  A_regt = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16) + 8],(5));
...
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  A_regt = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16) + 8],(6));
...
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  A_regt = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16) + 8],(7));
...
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(8));
  A_reg_1 = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16) + 8],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt) * (4)],(8));
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vv_f32m1(C_reg_0_1, A_reg_1, B_reg_0,(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 1) * (16)],(8));
  A_reg_1 = __riscv_vle32_v_f32m1(&A[(4 * kt + 1) * (16) + 8],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt + 1) * (4)],(8));
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vv_f32m1(C_reg_0_1, A_reg_1, B_reg_0,(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 2) * (16)],(8));
  A_reg_1 = __riscv_vle32_v_f32m1(&A[(4 * kt + 2) * (16) + 8],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt + 2) * (4)],(8));
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vv_f32m1(C_reg_0_1, A_reg_1, B_reg_0,(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(4 * kt + 3) * (16)],(8));
  A_reg_1 = __riscv_vle32_v_f32m1(&A[(4 * kt + 3) * (16) + 8],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt + 3) * (4)],(8));
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vv_f32m1(C_reg_0_1, A_reg_1, B_reg_0,(8));
}
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  A_reg_1 = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16) + 8],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(ktt + (KC / 4) * 4) * (4)],(8));
  C_reg_0_0 = __riscv_vfmacc_vv_f32m1(C_reg_0_0, A_reg_0, B_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vv_f32m1(C_reg_0_1, A_reg_1, B_reg_0,(8));
}
...
vfloat32m1_t B_reg_0;
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(5));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt) * (4)],(5));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(5));
  A_reg = __riscv_vle32_v_f32m1(&A[(1 + 4 * kt) * (16)],(5));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(1 + 4 * kt) * (4)],(5));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(5));
  A_reg = __riscv_vle32_v_f32m1(&A[(2 + 4 * kt) * (16)],(5));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(2 + 4 * kt) * (4)],(5));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(5));
  A_reg = __riscv_vle32_v_f32m1(&A[(3 + 4 * kt) * (16)],(5));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(3 + 4 * kt) * (4)],(5));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(5));
}
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(5));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(ktt + (KC / 4) * 4) * (4)],(5));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(5));
}
...
vfloat32m1_t B_reg_0;
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(6));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt) * (4)],(6));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(6));
  A_reg = __riscv_vle32_v_f32m1(&A[(1 + 4 * kt) * (16)],(6));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(1 + 4 * kt) * (4)],(6));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(6));
  A_reg = __riscv_vle32_v_f32m1(&A[(2 + 4 * kt) * (16)],(6));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(2 + 4 * kt) * (4)],(6));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(6));
  A_reg = __riscv_vle32_v_f32m1(&A[(3 + 4 * kt) * (16)],(6));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(3 + 4 * kt) * (4)],(6));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(6));
}
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(6));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(ktt + (KC / 4) * 4) * (4)],(6));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(6));
}
...
vfloat32m1_t B_reg_0;
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(7));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt) * (4)],(7));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(7));
  A_reg = __riscv_vle32_v_f32m1(&A[(1 + 4 * kt) * (16)],(7));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(1 + 4 * kt) * (4)],(7));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(7));
  A_reg = __riscv_vle32_v_f32m1(&A[(2 + 4 * kt) * (16)],(7));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(2 + 4 * kt) * (4)],(7));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(7));
  A_reg = __riscv_vle32_v_f32m1(&A[(3 + 4 * kt) * (16)],(7));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(3 + 4 * kt) * (4)],(7));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(7));
}
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(7));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(ktt + (KC / 4) * 4) * (4)],(7));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(7));
}
...
vfloat32m1_t B_reg_0;
for (int_fast32_t kt = 0; kt < ((KC) / (4)); kt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(4 * kt) * (16)],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(4 * kt) * (4)],(8));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(8));
  A_reg = __riscv_vle32_v_f32m1(&A[(1 + 4 * kt) * (16)],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(1 + 4 * kt) * (4)],(8));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(8));
  A_reg = __riscv_vle32_v_f32m1(&A[(2 + 4 * kt) * (16)],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(2 + 4 * kt) * (4)],(8));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(8));
  A_reg = __riscv_vle32_v_f32m1(&A[(3 + 4 * kt) * (16)],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(3 + 4 * kt) * (4)],(8));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(8));
}
for (int_fast32_t ktt = 0; ktt < KC % 4; ktt++) {
  A_reg = __riscv_vle32_v_f32m1(&A[(ktt + (KC / 4) * 4) * (16)],(8));
  B_reg_0 = __riscv_vfmv_v_f_f32m1(B[(ktt + (KC / 4) * 4) * (4)],(8));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(8));
}
