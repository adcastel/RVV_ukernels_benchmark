...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_4 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 32],(8));
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
  C_reg_0_4 = __riscv_vfmacc_vf_f16m1(C_reg_0_4, B[(k) * (ldb)], A_reg_4,(8));
  C_reg_0_5 = __riscv_vfmacc_vf_f16m1(C_reg_0_5, B[(k) * (ldb)], A_reg_5,(8));
  C_reg_0_6 = __riscv_vfmacc_vf_f16m1(C_reg_0_6, B[(k) * (ldb)], A_reg_6,(8));
}
__riscv_vse16_v_f16m1(&C[0], C_reg_0_0,(8));
__riscv_vse16_v_f16m1(&C[8], C_reg_0_1,(8));
__riscv_vse16_v_f16m1(&C[16], C_reg_0_2,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_1_4 = __riscv_vfmacc_vf_f16m1(C_reg_1_4, B[(k) * (ldb) + 1], A_reg_4,(8));
  C_reg_1_5 = __riscv_vfmacc_vf_f16m1(C_reg_1_5, B[(k) * (ldb) + 1], A_reg_5,(8));
  C_reg_1_6 = __riscv_vfmacc_vf_f16m1(C_reg_1_6, B[(k) * (ldb) + 1], A_reg_6,(8));
}
__riscv_vse16_v_f16m1(&C[0], C_reg_0_0,(8));
__riscv_vse16_v_f16m1(&C[8], C_reg_0_1,(8));
__riscv_vse16_v_f16m1(&C[16], C_reg_0_2,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(1));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(2));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(3));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(4));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(5));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(6));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_regt = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(7));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_5 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 40],(8));
  A_reg_6 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 48],(8));
  A_reg_7 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 56],(8));
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (ldb)], A_reg_0,(8));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (ldb)], A_reg_1,(8));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (ldb)], A_reg_2,(8));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (ldb)], A_reg_3,(8));
  ...
  C_reg_0_5 = __riscv_vfmacc_vf_f16m1(C_reg_0_5, B[(k) * (ldb)], A_reg_5,(8));
  C_reg_0_6 = __riscv_vfmacc_vf_f16m1(C_reg_0_6, B[(k) * (ldb)], A_reg_6,(8));
  C_reg_0_7 = __riscv_vfmacc_vf_f16m1(C_reg_0_7, B[(k) * (ldb)], A_reg_7,(8));
}
__riscv_vse16_v_f16m1(&C[0], C_reg_0_0,(8));
__riscv_vse16_v_f16m1(&C[8], C_reg_0_1,(8));
__riscv_vse16_v_f16m1(&C[16], C_reg_0_2,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_1_5 = __riscv_vfmacc_vf_f16m1(C_reg_1_5, B[(k) * (ldb) + 1], A_reg_5,(8));
  C_reg_1_6 = __riscv_vfmacc_vf_f16m1(C_reg_1_6, B[(k) * (ldb) + 1], A_reg_6,(8));
  C_reg_1_7 = __riscv_vfmacc_vf_f16m1(C_reg_1_7, B[(k) * (ldb) + 1], A_reg_7,(8));
}
__riscv_vse16_v_f16m1(&C[0], C_reg_0_0,(8));
__riscv_vse16_v_f16m1(&C[8], C_reg_0_1,(8));
__riscv_vse16_v_f16m1(&C[16], C_reg_0_2,(8));
