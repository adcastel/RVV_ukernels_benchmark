...
//     C : [f32][13, 25] @DRAM
// )
void gemm_RVV_25x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 25] @DRAM
// )
void gemm_RVV_25x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 25] @DRAM
// )
void gemm_RVV_25x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 25] @DRAM
// )
void gemm_RVV_25x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 26] @DRAM
// )
void gemm_RVV_26x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 26] @DRAM
// )
void gemm_RVV_26x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 26] @DRAM
// )
void gemm_RVV_26x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 26] @DRAM
// )
void gemm_RVV_26x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 27] @DRAM
// )
void gemm_RVV_27x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 27] @DRAM
// )
void gemm_RVV_27x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 27] @DRAM
// )
void gemm_RVV_27x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 27] @DRAM
// )
void gemm_RVV_27x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 28] @DRAM
// )
void gemm_RVV_28x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 28] @DRAM
// )
void gemm_RVV_28x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 28] @DRAM
// )
void gemm_RVV_28x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 28] @DRAM
// )
void gemm_RVV_28x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 29] @DRAM
// )
void gemm_RVV_29x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 29] @DRAM
// )
void gemm_RVV_29x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 29] @DRAM
// )
void gemm_RVV_29x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 29] @DRAM
// )
void gemm_RVV_29x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 30] @DRAM
// )
void gemm_RVV_30x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 30] @DRAM
// )
void gemm_RVV_30x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 30] @DRAM
// )
void gemm_RVV_30x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 30] @DRAM
// )
void gemm_RVV_30x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 31] @DRAM
// )
void gemm_RVV_31x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 31] @DRAM
// )
void gemm_RVV_31x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 31] @DRAM
// )
void gemm_RVV_31x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 31] @DRAM
// )
void gemm_RVV_31x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 32] @DRAM
// )
void gemm_RVV_32x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 32] @DRAM
// )
void gemm_RVV_32x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 32] @DRAM
// )
void gemm_RVV_32x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 32] @DRAM
// )
void gemm_RVV_32x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
