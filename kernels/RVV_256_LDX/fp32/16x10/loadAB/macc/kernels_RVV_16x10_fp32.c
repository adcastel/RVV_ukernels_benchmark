...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1(C_reg_4_0, B[(k) * (ldb) + 4], A_reg_0,(8));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1(C_reg_5_0, B[(k) * (ldb) + 5], A_reg_0,(8));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1(C_reg_6_0, B[(k) * (ldb) + 6], A_reg_0,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1(C_reg_7_0, B[(k) * (ldb) + 7], A_reg_0,(8));
  C_reg_8_0 = __riscv_vfmacc_vf_f32m1(C_reg_8_0, B[(k) * (ldb) + 8], A_reg_0,(8));
  C_reg_9_0 = __riscv_vfmacc_vf_f32m1(C_reg_9_0, B[(k) * (ldb) + 9], A_reg_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_regt_4 = __riscv_vfmacc_vf_f32m1(C_regt_4, B[(k) * (ldb) + 4], A_regt,(4));
  C_regt_5 = __riscv_vfmacc_vf_f32m1(C_regt_5, B[(k) * (ldb) + 5], A_regt,(4));
  C_regt_6 = __riscv_vfmacc_vf_f32m1(C_regt_6, B[(k) * (ldb) + 6], A_regt,(4));
  C_regt_7 = __riscv_vfmacc_vf_f32m1(C_regt_7, B[(k) * (ldb) + 7], A_regt,(4));
  C_regt_8 = __riscv_vfmacc_vf_f32m1(C_regt_8, B[(k) * (ldb) + 8], A_regt,(4));
  C_regt_9 = __riscv_vfmacc_vf_f32m1(C_regt_9, B[(k) * (ldb) + 9], A_regt,(4));
}
__riscv_vse32_v_f32m1(&C[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C[ldc], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C[(2) * (ldc)], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_regt_4 = __riscv_vfmacc_vf_f32m1(C_regt_4, B[(k) * (ldb) + 4], A_regt,(5));
  C_regt_5 = __riscv_vfmacc_vf_f32m1(C_regt_5, B[(k) * (ldb) + 5], A_regt,(5));
  C_regt_6 = __riscv_vfmacc_vf_f32m1(C_regt_6, B[(k) * (ldb) + 6], A_regt,(5));
  C_regt_7 = __riscv_vfmacc_vf_f32m1(C_regt_7, B[(k) * (ldb) + 7], A_regt,(5));
  C_regt_8 = __riscv_vfmacc_vf_f32m1(C_regt_8, B[(k) * (ldb) + 8], A_regt,(5));
  C_regt_9 = __riscv_vfmacc_vf_f32m1(C_regt_9, B[(k) * (ldb) + 9], A_regt,(5));
}
__riscv_vse32_v_f32m1(&C[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C[ldc], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C[(2) * (ldc)], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_regt_4 = __riscv_vfmacc_vf_f32m1(C_regt_4, B[(k) * (ldb) + 4], A_regt,(6));
  C_regt_5 = __riscv_vfmacc_vf_f32m1(C_regt_5, B[(k) * (ldb) + 5], A_regt,(6));
  C_regt_6 = __riscv_vfmacc_vf_f32m1(C_regt_6, B[(k) * (ldb) + 6], A_regt,(6));
  C_regt_7 = __riscv_vfmacc_vf_f32m1(C_regt_7, B[(k) * (ldb) + 7], A_regt,(6));
  C_regt_8 = __riscv_vfmacc_vf_f32m1(C_regt_8, B[(k) * (ldb) + 8], A_regt,(6));
  C_regt_9 = __riscv_vfmacc_vf_f32m1(C_regt_9, B[(k) * (ldb) + 9], A_regt,(6));
}
__riscv_vse32_v_f32m1(&C[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C[ldc], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C[(2) * (ldc)], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_regt_4 = __riscv_vfmacc_vf_f32m1(C_regt_4, B[(k) * (ldb) + 4], A_regt,(7));
  C_regt_5 = __riscv_vfmacc_vf_f32m1(C_regt_5, B[(k) * (ldb) + 5], A_regt,(7));
  C_regt_6 = __riscv_vfmacc_vf_f32m1(C_regt_6, B[(k) * (ldb) + 6], A_regt,(7));
  C_regt_7 = __riscv_vfmacc_vf_f32m1(C_regt_7, B[(k) * (ldb) + 7], A_regt,(7));
  C_regt_8 = __riscv_vfmacc_vf_f32m1(C_regt_8, B[(k) * (ldb) + 8], A_regt,(7));
  C_regt_9 = __riscv_vfmacc_vf_f32m1(C_regt_9, B[(k) * (ldb) + 9], A_regt,(7));
}
__riscv_vse32_v_f32m1(&C[0], C_reg_0_0,(8));
__riscv_vse32_v_f32m1(&C[ldc], C_reg_1_0,(8));
__riscv_vse32_v_f32m1(&C[(2) * (ldc)], C_reg_2_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1(C_reg_4_0, B[(k) * (ldb) + 4], A_reg_0,(8));
  C_reg_4_1 = __riscv_vfmacc_vf_f32m1(C_reg_4_1, B[(k) * (ldb) + 4], A_reg_1,(8));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1(C_reg_5_0, B[(k) * (ldb) + 5], A_reg_0,(8));
  C_reg_5_1 = __riscv_vfmacc_vf_f32m1(C_reg_5_1, B[(k) * (ldb) + 5], A_reg_1,(8));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1(C_reg_6_0, B[(k) * (ldb) + 6], A_reg_0,(8));
  C_reg_6_1 = __riscv_vfmacc_vf_f32m1(C_reg_6_1, B[(k) * (ldb) + 6], A_reg_1,(8));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1(C_reg_7_0, B[(k) * (ldb) + 7], A_reg_0,(8));
  C_reg_7_1 = __riscv_vfmacc_vf_f32m1(C_reg_7_1, B[(k) * (ldb) + 7], A_reg_1,(8));
  C_reg_8_0 = __riscv_vfmacc_vf_f32m1(C_reg_8_0, B[(k) * (ldb) + 8], A_reg_0,(8));
  C_reg_8_1 = __riscv_vfmacc_vf_f32m1(C_reg_8_1, B[(k) * (ldb) + 8], A_reg_1,(8));
  C_reg_9_0 = __riscv_vfmacc_vf_f32m1(C_reg_9_0, B[(k) * (ldb) + 9], A_reg_0,(8));
  C_reg_9_1 = __riscv_vfmacc_vf_f32m1(C_reg_9_1, B[(k) * (ldb) + 9], A_reg_1,(8));
}
__riscv_vse32_v_f32m1(&C[0], C_reg_0_0,(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4 = __riscv_vfmacc_vf_f32m1(C_reg_4, B[(k) * (ldb) + 4], A_reg,(5));
  C_reg_5 = __riscv_vfmacc_vf_f32m1(C_reg_5, B[(k) * (ldb) + 5], A_reg,(5));
  C_reg_6 = __riscv_vfmacc_vf_f32m1(C_reg_6, B[(k) * (ldb) + 6], A_reg,(5));
  C_reg_7 = __riscv_vfmacc_vf_f32m1(C_reg_7, B[(k) * (ldb) + 7], A_reg,(5));
  C_reg_8 = __riscv_vfmacc_vf_f32m1(C_reg_8, B[(k) * (ldb) + 8], A_reg,(5));
  C_reg_9 = __riscv_vfmacc_vf_f32m1(C_reg_9, B[(k) * (ldb) + 9], A_reg,(5));
}
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4 = __riscv_vfmacc_vf_f32m1(C_reg_4, B[(k) * (ldb) + 4], A_reg,(6));
  C_reg_5 = __riscv_vfmacc_vf_f32m1(C_reg_5, B[(k) * (ldb) + 5], A_reg,(6));
  C_reg_6 = __riscv_vfmacc_vf_f32m1(C_reg_6, B[(k) * (ldb) + 6], A_reg,(6));
  C_reg_7 = __riscv_vfmacc_vf_f32m1(C_reg_7, B[(k) * (ldb) + 7], A_reg,(6));
  C_reg_8 = __riscv_vfmacc_vf_f32m1(C_reg_8, B[(k) * (ldb) + 8], A_reg,(6));
  C_reg_9 = __riscv_vfmacc_vf_f32m1(C_reg_9, B[(k) * (ldb) + 9], A_reg,(6));
}
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4 = __riscv_vfmacc_vf_f32m1(C_reg_4, B[(k) * (ldb) + 4], A_reg,(7));
  C_reg_5 = __riscv_vfmacc_vf_f32m1(C_reg_5, B[(k) * (ldb) + 5], A_reg,(7));
  C_reg_6 = __riscv_vfmacc_vf_f32m1(C_reg_6, B[(k) * (ldb) + 6], A_reg,(7));
  C_reg_7 = __riscv_vfmacc_vf_f32m1(C_reg_7, B[(k) * (ldb) + 7], A_reg,(7));
  C_reg_8 = __riscv_vfmacc_vf_f32m1(C_reg_8, B[(k) * (ldb) + 8], A_reg,(7));
  C_reg_9 = __riscv_vfmacc_vf_f32m1(C_reg_9, B[(k) * (ldb) + 9], A_reg,(7));
}
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4 = __riscv_vfmacc_vf_f32m1(C_reg_4, B[(k) * (ldb) + 4], A_reg,(8));
  C_reg_5 = __riscv_vfmacc_vf_f32m1(C_reg_5, B[(k) * (ldb) + 5], A_reg,(8));
  C_reg_6 = __riscv_vfmacc_vf_f32m1(C_reg_6, B[(k) * (ldb) + 6], A_reg,(8));
  C_reg_7 = __riscv_vfmacc_vf_f32m1(C_reg_7, B[(k) * (ldb) + 7], A_reg,(8));
  C_reg_8 = __riscv_vfmacc_vf_f32m1(C_reg_8, B[(k) * (ldb) + 8], A_reg,(8));
  C_reg_9 = __riscv_vfmacc_vf_f32m1(C_reg_9, B[(k) * (ldb) + 9], A_reg,(8));
}
