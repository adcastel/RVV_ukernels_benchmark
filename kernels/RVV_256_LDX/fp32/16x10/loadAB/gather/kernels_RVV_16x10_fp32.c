...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(2));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(2));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(3));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(3));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(4));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(4));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(5));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(5));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(6));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(6));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(7));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(7));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg_0 = __riscv_vle32_v_f32m1(&A[(k) * (lda)],(8));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(1));
  A_reg1 = __riscv_vle32_v_f32m1(&A[(k) * (lda) + 8],(1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (ldb)],(8));
  B_reg_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
