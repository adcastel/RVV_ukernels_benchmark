...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_6_4 = __riscv_vfmacc_vf_f16m1(C_reg_6_4, B[(k) * (ldb) + 6], A_reg_4,(16));
  ...
  C_reg_7_4 = __riscv_vfmacc_vf_f16m1(C_reg_7_4, B[(k) * (ldb) + 7], A_reg_4,(16));
  ...
  C_reg_8_4 = __riscv_vfmacc_vf_f16m1(C_reg_8_4, B[(k) * (ldb) + 8], A_reg_4,(16));
  ...
  C_reg_9_4 = __riscv_vfmacc_vf_f16m1(C_reg_9_4, B[(k) * (ldb) + 9], A_reg_4,(16));
}
...
__riscv_vse16_v_f16m1(&C[(8) * (ldc) + 64], C_reg_8_4,(16));
...
__riscv_vse16_v_f16m1(&C[(9) * (ldc) + 64], C_reg_9_4,(16));
}
...
C_reg_8_4 = __riscv_vle16_v_f16m1(&C[(8) * (ldc) + 64],(16));
...
C_reg_9_4 = __riscv_vle16_v_f16m1(&C[(9) * (ldc) + 64],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A[(k) * (lda)],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A[(k) * (lda) + 32],(16));
