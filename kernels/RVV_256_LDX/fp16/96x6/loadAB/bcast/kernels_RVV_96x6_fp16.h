...
//     C : [f16][5, 81] @DRAM
// )
void gemm_RVV_81x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 81] @DRAM
// )
void gemm_RVV_81x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 81] @DRAM
// )
void gemm_RVV_81x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 81] @DRAM
// )
void gemm_RVV_81x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 82] @DRAM
// )
void gemm_RVV_82x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 82] @DRAM
// )
void gemm_RVV_82x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 82] @DRAM
// )
void gemm_RVV_82x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 82] @DRAM
// )
void gemm_RVV_82x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 83] @DRAM
// )
void gemm_RVV_83x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 83] @DRAM
// )
void gemm_RVV_83x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 83] @DRAM
// )
void gemm_RVV_83x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 83] @DRAM
// )
void gemm_RVV_83x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 84] @DRAM
// )
void gemm_RVV_84x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 84] @DRAM
// )
void gemm_RVV_84x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 84] @DRAM
// )
void gemm_RVV_84x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 84] @DRAM
// )
void gemm_RVV_84x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 85] @DRAM
// )
void gemm_RVV_85x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 85] @DRAM
// )
void gemm_RVV_85x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 85] @DRAM
// )
void gemm_RVV_85x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 85] @DRAM
// )
void gemm_RVV_85x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 86] @DRAM
// )
void gemm_RVV_86x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 86] @DRAM
// )
void gemm_RVV_86x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 86] @DRAM
// )
void gemm_RVV_86x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 86] @DRAM
// )
void gemm_RVV_86x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 87] @DRAM
// )
void gemm_RVV_87x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 87] @DRAM
// )
void gemm_RVV_87x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 87] @DRAM
// )
void gemm_RVV_87x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 87] @DRAM
// )
void gemm_RVV_87x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 88] @DRAM
// )
void gemm_RVV_88x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 88] @DRAM
// )
void gemm_RVV_88x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 88] @DRAM
// )
void gemm_RVV_88x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 88] @DRAM
// )
void gemm_RVV_88x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 89] @DRAM
// )
void gemm_RVV_89x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 89] @DRAM
// )
void gemm_RVV_89x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 89] @DRAM
// )
void gemm_RVV_89x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 89] @DRAM
// )
void gemm_RVV_89x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 90] @DRAM
// )
void gemm_RVV_90x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 90] @DRAM
// )
void gemm_RVV_90x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 90] @DRAM
// )
void gemm_RVV_90x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 90] @DRAM
// )
void gemm_RVV_90x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 91] @DRAM
// )
void gemm_RVV_91x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 91] @DRAM
// )
void gemm_RVV_91x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 91] @DRAM
// )
void gemm_RVV_91x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 91] @DRAM
// )
void gemm_RVV_91x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 92] @DRAM
// )
void gemm_RVV_92x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 92] @DRAM
// )
void gemm_RVV_92x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 92] @DRAM
// )
void gemm_RVV_92x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 92] @DRAM
// )
void gemm_RVV_92x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 93] @DRAM
// )
void gemm_RVV_93x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 93] @DRAM
// )
void gemm_RVV_93x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 93] @DRAM
// )
void gemm_RVV_93x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 93] @DRAM
// )
void gemm_RVV_93x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 94] @DRAM
// )
void gemm_RVV_94x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 94] @DRAM
// )
void gemm_RVV_94x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 94] @DRAM
// )
void gemm_RVV_94x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 94] @DRAM
// )
void gemm_RVV_94x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 95] @DRAM
// )
void gemm_RVV_95x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 95] @DRAM
// )
void gemm_RVV_95x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 95] @DRAM
// )
void gemm_RVV_95x6_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][6, 95] @DRAM
// )
void gemm_RVV_95x6_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 96] @DRAM
// )
void gemm_RVV_96x5_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][5, 96] @DRAM
// )
void gemm_RVV_96x5_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
