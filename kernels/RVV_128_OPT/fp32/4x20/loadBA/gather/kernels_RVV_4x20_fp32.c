...
for (int_fast32_t k = 0; k < KC; k++) {
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20)],(4));
  ...
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 4],(4));
  ...
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 8],(2));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_6 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_7 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 8],(3));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_6 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_7 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 8],(4));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_10 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_11 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 12],(1));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_10 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_11 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 12],(2));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_10 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_11 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 12],(3));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  B_reg2_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_10 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_11 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 12],(4));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_14 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_15 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 16],(1));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_14 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_15 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 16],(2));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_14 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_15 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 16],(3));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  B_reg2_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_14 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_15 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 16],(4));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_3 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 4],(1));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_3 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 4],(2));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_3 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 4],(3));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  B_reg2_1 = __riscv_vrgather_vx_f32m1(B_tmp, (1), (1));
  B_reg2_2 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  B_reg_6 = __riscv_vrgather_vx_f32m1(B_tmp, (2), (1));
  B_reg_7 = __riscv_vrgather_vx_f32m1(B_tmp, (3), (1));
  B_tmp = __riscv_vle32_v_f32m1(&B[(k) * (20) + 8],(1));
  B_reg2_0 = __riscv_vrgather_vx_f32m1(B_tmp, (0), (1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  A_reg = __riscv_vle32_v_f32m1(&A[(k) * (4)],(1));
  C_reg_0 = __riscv_vfmacc_vv_f32m1(C_reg_0, A_reg, B_reg_0,(1));
