...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_2_0 = __riscv_vfmacc_vf_f32m1(C_reg_2_0, B.data[(k) * (B.strides[0]) + 2], A_reg_0,(4));
  C_reg_2_1 = __riscv_vfmacc_vf_f32m1(C_reg_2_1, B.data[(k) * (B.strides[0]) + 2], A_reg_1,(4));
  C_reg_3_0 = __riscv_vfmacc_vf_f32m1(C_reg_3_0, B.data[(k) * (B.strides[0]) + 3], A_reg_0,(4));
  C_reg_3_1 = __riscv_vfmacc_vf_f32m1(C_reg_3_1, B.data[(k) * (B.strides[0]) + 3], A_reg_1,(4));
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1(C_reg_4_0, B.data[(k) * (B.strides[0]) + 4], A_reg_0,(4));
  C_reg_4_1 = __riscv_vfmacc_vf_f32m1(C_reg_4_1, B.data[(k) * (B.strides[0]) + 4], A_reg_1,(4));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1(C_reg_5_0, B.data[(k) * (B.strides[0]) + 5], A_reg_0,(4));
  C_reg_5_1 = __riscv_vfmacc_vf_f32m1(C_reg_5_1, B.data[(k) * (B.strides[0]) + 5], A_reg_1,(4));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1(C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(4));
  C_reg_6_1 = __riscv_vfmacc_vf_f32m1(C_reg_6_1, B.data[(k) * (B.strides[0]) + 6], A_reg_1,(4));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1(C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(4));
  C_reg_7_1 = __riscv_vfmacc_vf_f32m1(C_reg_7_1, B.data[(k) * (B.strides[0]) + 7], A_reg_1,(4));
  C_reg_8_0 = __riscv_vfmacc_vf_f32m1(C_reg_8_0, B.data[(k) * (B.strides[0]) + 8], A_reg_0,(4));
  C_reg_8_1 = __riscv_vfmacc_vf_f32m1(C_reg_8_1, B.data[(k) * (B.strides[0]) + 8], A_reg_1,(4));
  C_reg_9_0 = __riscv_vfmacc_vf_f32m1(C_reg_9_0, B.data[(k) * (B.strides[0]) + 9], A_reg_0,(4));
  C_reg_9_1 = __riscv_vfmacc_vf_f32m1(C_reg_9_1, B.data[(k) * (B.strides[0]) + 9], A_reg_1,(4));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_2_0 = __riscv_vfmacc_vf_f32m1(C_reg_2_0, B.data[(k) * (B.strides[0]) + 2], A_reg_0,(4));
  C_reg_2_1 = __riscv_vfmacc_vf_f32m1(C_reg_2_1, B.data[(k) * (B.strides[0]) + 2], A_reg_1,(4));
  C_reg_2_2 = __riscv_vfmacc_vf_f32m1(C_reg_2_2, B.data[(k) * (B.strides[0]) + 2], A_reg_2,(4));
  C_reg_3_0 = __riscv_vfmacc_vf_f32m1(C_reg_3_0, B.data[(k) * (B.strides[0]) + 3], A_reg_0,(4));
  C_reg_3_1 = __riscv_vfmacc_vf_f32m1(C_reg_3_1, B.data[(k) * (B.strides[0]) + 3], A_reg_1,(4));
  C_reg_3_2 = __riscv_vfmacc_vf_f32m1(C_reg_3_2, B.data[(k) * (B.strides[0]) + 3], A_reg_2,(4));
  C_reg_4_0 = __riscv_vfmacc_vf_f32m1(C_reg_4_0, B.data[(k) * (B.strides[0]) + 4], A_reg_0,(4));
  C_reg_4_1 = __riscv_vfmacc_vf_f32m1(C_reg_4_1, B.data[(k) * (B.strides[0]) + 4], A_reg_1,(4));
  C_reg_4_2 = __riscv_vfmacc_vf_f32m1(C_reg_4_2, B.data[(k) * (B.strides[0]) + 4], A_reg_2,(4));
  C_reg_5_0 = __riscv_vfmacc_vf_f32m1(C_reg_5_0, B.data[(k) * (B.strides[0]) + 5], A_reg_0,(4));
  C_reg_5_1 = __riscv_vfmacc_vf_f32m1(C_reg_5_1, B.data[(k) * (B.strides[0]) + 5], A_reg_1,(4));
  C_reg_5_2 = __riscv_vfmacc_vf_f32m1(C_reg_5_2, B.data[(k) * (B.strides[0]) + 5], A_reg_2,(4));
  C_reg_6_0 = __riscv_vfmacc_vf_f32m1(C_reg_6_0, B.data[(k) * (B.strides[0]) + 6], A_reg_0,(4));
  C_reg_6_1 = __riscv_vfmacc_vf_f32m1(C_reg_6_1, B.data[(k) * (B.strides[0]) + 6], A_reg_1,(4));
  C_reg_6_2 = __riscv_vfmacc_vf_f32m1(C_reg_6_2, B.data[(k) * (B.strides[0]) + 6], A_reg_2,(4));
  C_reg_7_0 = __riscv_vfmacc_vf_f32m1(C_reg_7_0, B.data[(k) * (B.strides[0]) + 7], A_reg_0,(4));
  C_reg_7_1 = __riscv_vfmacc_vf_f32m1(C_reg_7_1, B.data[(k) * (B.strides[0]) + 7], A_reg_1,(4));
  C_reg_7_2 = __riscv_vfmacc_vf_f32m1(C_reg_7_2, B.data[(k) * (B.strides[0]) + 7], A_reg_2,(4));
  C_reg_8_0 = __riscv_vfmacc_vf_f32m1(C_reg_8_0, B.data[(k) * (B.strides[0]) + 8], A_reg_0,(4));
  C_reg_8_1 = __riscv_vfmacc_vf_f32m1(C_reg_8_1, B.data[(k) * (B.strides[0]) + 8], A_reg_1,(4));
  C_reg_8_2 = __riscv_vfmacc_vf_f32m1(C_reg_8_2, B.data[(k) * (B.strides[0]) + 8], A_reg_2,(4));
  C_reg_9_0 = __riscv_vfmacc_vf_f32m1(C_reg_9_0, B.data[(k) * (B.strides[0]) + 9], A_reg_0,(4));
  C_reg_9_1 = __riscv_vfmacc_vf_f32m1(C_reg_9_1, B.data[(k) * (B.strides[0]) + 9], A_reg_1,(4));
  C_reg_9_2 = __riscv_vfmacc_vf_f32m1(C_reg_9_2, B.data[(k) * (B.strides[0]) + 9], A_reg_2,(4));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(4));
__riscv_vse32_v_f32m1(&C.data[4], C_reg_0_1,(4));
...
__riscv_vse32_v_f32m1(&C.data[(8) * (C.strides[0])], C_reg_8_0,(4));
__riscv_vse32_v_f32m1(&C.data[(8) * (C.strides[0]) + 4], C_reg_8_1,(4));
__riscv_vse32_v_f32m1(&C.data[(8) * (C.strides[0]) + 8], C_reg_8_2,(4));
__riscv_vse32_v_f32m1(&C.data[(9) * (C.strides[0])], C_reg_9_0,(4));
__riscv_vse32_v_f32m1(&C.data[(9) * (C.strides[0]) + 4], C_reg_9_1,(4));
__riscv_vse32_v_f32m1(&C.data[(9) * (C.strides[0]) + 8], C_reg_9_2,(4));
}
...
C_reg_8_0 = __riscv_vle32_v_f32m1(&C.data[(8) * (C.strides[0])],(4));
C_reg_8_1 = __riscv_vle32_v_f32m1(&C.data[(8) * (C.strides[0]) + 4],(4));
C_reg_8_2 = __riscv_vle32_v_f32m1(&C.data[(8) * (C.strides[0]) + 8],(4));
C_reg_9_0 = __riscv_vle32_v_f32m1(&C.data[(9) * (C.strides[0])],(4));
C_reg_9_1 = __riscv_vle32_v_f32m1(&C.data[(9) * (C.strides[0]) + 4],(4));
C_reg_9_2 = __riscv_vle32_v_f32m1(&C.data[(9) * (C.strides[0]) + 8],(4));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0])],(4));
  A_reg_1 = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0]) + 4],(4));
  A_reg_2 = __riscv_vle32_v_f32m1(&A.data[(k) * (A.strides[0]) + 8],(4));
