...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_4_2 = __riscv_vfmacc_vf_f32m1(C_reg_4_2, B.data[(k) * (B.strides[0]) + 4], A_reg_2,(4));
  C_reg_4_3 = __riscv_vfmacc_vf_f32m1(C_reg_4_3, B.data[(k) * (B.strides[0]) + 4], A_reg_3,(4));
  C_reg_4_4 = __riscv_vfmacc_vf_f32m1(C_reg_4_4, B.data[(k) * (B.strides[0]) + 4], A_reg_4,(4));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(4));
__riscv_vse32_v_f32m1(&C.data[4], C_reg_0_1,(4));
__riscv_vse32_v_f32m1(&C.data[8], C_reg_0_2,(4));
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_5_2 = __riscv_vfmacc_vf_f32m1(C_reg_5_2, B.data[(k) * (B.strides[0]) + 5], A_reg_2,(4));
  C_reg_5_3 = __riscv_vfmacc_vf_f32m1(C_reg_5_3, B.data[(k) * (B.strides[0]) + 5], A_reg_3,(4));
  C_reg_5_4 = __riscv_vfmacc_vf_f32m1(C_reg_5_4, B.data[(k) * (B.strides[0]) + 5], A_reg_4,(4));
}
__riscv_vse32_v_f32m1(&C.data[0], C_reg_0_0,(4));
__riscv_vse32_v_f32m1(&C.data[4], C_reg_0_1,(4));
__riscv_vse32_v_f32m1(&C.data[8], C_reg_0_2,(4));
