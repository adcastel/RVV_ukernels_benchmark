...
//     C : [f16][12, 64] @DRAM
// )
void gemm_RVV_64x12_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (12)], A_reg_0,(16));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (12)], A_reg_1,(16));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (12)], A_reg_2,(16));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (12)], A_reg_3,(16));
  C_reg_1_0 = __riscv_vfmacc_vf_f16m1(C_reg_1_0, B[(k) * (12) + 1], A_reg_0,(16));
  C_reg_1_1 = __riscv_vfmacc_vf_f16m1(C_reg_1_1, B[(k) * (12) + 1], A_reg_1,(16));
  C_reg_1_2 = __riscv_vfmacc_vf_f16m1(C_reg_1_2, B[(k) * (12) + 1], A_reg_2,(16));
  C_reg_1_3 = __riscv_vfmacc_vf_f16m1(C_reg_1_3, B[(k) * (12) + 1], A_reg_3,(16));
  C_reg_2_0 = __riscv_vfmacc_vf_f16m1(C_reg_2_0, B[(k) * (12) + 2], A_reg_0,(16));
  C_reg_2_1 = __riscv_vfmacc_vf_f16m1(C_reg_2_1, B[(k) * (12) + 2], A_reg_1,(16));
  C_reg_2_2 = __riscv_vfmacc_vf_f16m1(C_reg_2_2, B[(k) * (12) + 2], A_reg_2,(16));
  C_reg_2_3 = __riscv_vfmacc_vf_f16m1(C_reg_2_3, B[(k) * (12) + 2], A_reg_3,(16));
  C_reg_3_0 = __riscv_vfmacc_vf_f16m1(C_reg_3_0, B[(k) * (12) + 3], A_reg_0,(16));
  C_reg_3_1 = __riscv_vfmacc_vf_f16m1(C_reg_3_1, B[(k) * (12) + 3], A_reg_1,(16));
  C_reg_3_2 = __riscv_vfmacc_vf_f16m1(C_reg_3_2, B[(k) * (12) + 3], A_reg_2,(16));
  C_reg_3_3 = __riscv_vfmacc_vf_f16m1(C_reg_3_3, B[(k) * (12) + 3], A_reg_3,(16));
  C_reg_4_0 = __riscv_vfmacc_vf_f16m1(C_reg_4_0, B[(k) * (12) + 4], A_reg_0,(16));
  C_reg_4_1 = __riscv_vfmacc_vf_f16m1(C_reg_4_1, B[(k) * (12) + 4], A_reg_1,(16));
  C_reg_4_2 = __riscv_vfmacc_vf_f16m1(C_reg_4_2, B[(k) * (12) + 4], A_reg_2,(16));
  C_reg_4_3 = __riscv_vfmacc_vf_f16m1(C_reg_4_3, B[(k) * (12) + 4], A_reg_3,(16));
  C_reg_5_0 = __riscv_vfmacc_vf_f16m1(C_reg_5_0, B[(k) * (12) + 5], A_reg_0,(16));
  C_reg_5_1 = __riscv_vfmacc_vf_f16m1(C_reg_5_1, B[(k) * (12) + 5], A_reg_1,(16));
  C_reg_5_2 = __riscv_vfmacc_vf_f16m1(C_reg_5_2, B[(k) * (12) + 5], A_reg_2,(16));
  C_reg_5_3 = __riscv_vfmacc_vf_f16m1(C_reg_5_3, B[(k) * (12) + 5], A_reg_3,(16));
  C_reg_6_0 = __riscv_vfmacc_vf_f16m1(C_reg_6_0, B[(k) * (12) + 6], A_reg_0,(16));
  C_reg_6_1 = __riscv_vfmacc_vf_f16m1(C_reg_6_1, B[(k) * (12) + 6], A_reg_1,(16));
  C_reg_6_2 = __riscv_vfmacc_vf_f16m1(C_reg_6_2, B[(k) * (12) + 6], A_reg_2,(16));
  C_reg_6_3 = __riscv_vfmacc_vf_f16m1(C_reg_6_3, B[(k) * (12) + 6], A_reg_3,(16));
  C_reg_7_0 = __riscv_vfmacc_vf_f16m1(C_reg_7_0, B[(k) * (12) + 7], A_reg_0,(16));
  C_reg_7_1 = __riscv_vfmacc_vf_f16m1(C_reg_7_1, B[(k) * (12) + 7], A_reg_1,(16));
  C_reg_7_2 = __riscv_vfmacc_vf_f16m1(C_reg_7_2, B[(k) * (12) + 7], A_reg_2,(16));
  C_reg_7_3 = __riscv_vfmacc_vf_f16m1(C_reg_7_3, B[(k) * (12) + 7], A_reg_3,(16));
  C_reg_8_0 = __riscv_vfmacc_vf_f16m1(C_reg_8_0, B[(k) * (12) + 8], A_reg_0,(16));
  C_reg_8_1 = __riscv_vfmacc_vf_f16m1(C_reg_8_1, B[(k) * (12) + 8], A_reg_1,(16));
  C_reg_8_2 = __riscv_vfmacc_vf_f16m1(C_reg_8_2, B[(k) * (12) + 8], A_reg_2,(16));
  C_reg_8_3 = __riscv_vfmacc_vf_f16m1(C_reg_8_3, B[(k) * (12) + 8], A_reg_3,(16));
  C_reg_9_0 = __riscv_vfmacc_vf_f16m1(C_reg_9_0, B[(k) * (12) + 9], A_reg_0,(16));
  C_reg_9_1 = __riscv_vfmacc_vf_f16m1(C_reg_9_1, B[(k) * (12) + 9], A_reg_1,(16));
  C_reg_9_2 = __riscv_vfmacc_vf_f16m1(C_reg_9_2, B[(k) * (12) + 9], A_reg_2,(16));
  C_reg_9_3 = __riscv_vfmacc_vf_f16m1(C_reg_9_3, B[(k) * (12) + 9], A_reg_3,(16));
  C_reg_10_0 = __riscv_vfmacc_vf_f16m1(C_reg_10_0, B[(k) * (12) + 10], A_reg_0,(16));
  C_reg_10_1 = __riscv_vfmacc_vf_f16m1(C_reg_10_1, B[(k) * (12) + 10], A_reg_1,(16));
  C_reg_10_2 = __riscv_vfmacc_vf_f16m1(C_reg_10_2, B[(k) * (12) + 10], A_reg_2,(16));
  C_reg_10_3 = __riscv_vfmacc_vf_f16m1(C_reg_10_3, B[(k) * (12) + 10], A_reg_3,(16));
  C_reg_11_0 = __riscv_vfmacc_vf_f16m1(C_reg_11_0, B[(k) * (12) + 11], A_reg_0,(16));
  C_reg_11_1 = __riscv_vfmacc_vf_f16m1(C_reg_11_1, B[(k) * (12) + 11], A_reg_1,(16));
  C_reg_11_2 = __riscv_vfmacc_vf_f16m1(C_reg_11_2, B[(k) * (12) + 11], A_reg_2,(16));
  C_reg_11_3 = __riscv_vfmacc_vf_f16m1(C_reg_11_3, B[(k) * (12) + 11], A_reg_3,(16));
}
...
//     C : [f16][12, 64] @DRAM
// )
void gemm_RVV_64x12_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
