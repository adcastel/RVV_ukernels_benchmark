#include "kernels_RVV_64x14_fp16.h"
...
//     C : [f16][14, 64] @DRAM
// )
void gemm_RVV_64x14_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
C_reg_12_3 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
...
C_reg_13_3 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (14)], A_reg_0,(16));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (14)], A_reg_1,(16));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (14)], A_reg_2,(16));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (14)], A_reg_3,(16));
  C_reg_1_0 = __riscv_vfmacc_vf_f16m1(C_reg_1_0, B[(k) * (14) + 1], A_reg_0,(16));
  C_reg_1_1 = __riscv_vfmacc_vf_f16m1(C_reg_1_1, B[(k) * (14) + 1], A_reg_1,(16));
  C_reg_1_2 = __riscv_vfmacc_vf_f16m1(C_reg_1_2, B[(k) * (14) + 1], A_reg_2,(16));
  C_reg_1_3 = __riscv_vfmacc_vf_f16m1(C_reg_1_3, B[(k) * (14) + 1], A_reg_3,(16));
  C_reg_2_0 = __riscv_vfmacc_vf_f16m1(C_reg_2_0, B[(k) * (14) + 2], A_reg_0,(16));
  C_reg_2_1 = __riscv_vfmacc_vf_f16m1(C_reg_2_1, B[(k) * (14) + 2], A_reg_1,(16));
  C_reg_2_2 = __riscv_vfmacc_vf_f16m1(C_reg_2_2, B[(k) * (14) + 2], A_reg_2,(16));
  C_reg_2_3 = __riscv_vfmacc_vf_f16m1(C_reg_2_3, B[(k) * (14) + 2], A_reg_3,(16));
  C_reg_3_0 = __riscv_vfmacc_vf_f16m1(C_reg_3_0, B[(k) * (14) + 3], A_reg_0,(16));
  C_reg_3_1 = __riscv_vfmacc_vf_f16m1(C_reg_3_1, B[(k) * (14) + 3], A_reg_1,(16));
  C_reg_3_2 = __riscv_vfmacc_vf_f16m1(C_reg_3_2, B[(k) * (14) + 3], A_reg_2,(16));
  C_reg_3_3 = __riscv_vfmacc_vf_f16m1(C_reg_3_3, B[(k) * (14) + 3], A_reg_3,(16));
  C_reg_4_0 = __riscv_vfmacc_vf_f16m1(C_reg_4_0, B[(k) * (14) + 4], A_reg_0,(16));
  C_reg_4_1 = __riscv_vfmacc_vf_f16m1(C_reg_4_1, B[(k) * (14) + 4], A_reg_1,(16));
  C_reg_4_2 = __riscv_vfmacc_vf_f16m1(C_reg_4_2, B[(k) * (14) + 4], A_reg_2,(16));
  C_reg_4_3 = __riscv_vfmacc_vf_f16m1(C_reg_4_3, B[(k) * (14) + 4], A_reg_3,(16));
  C_reg_5_0 = __riscv_vfmacc_vf_f16m1(C_reg_5_0, B[(k) * (14) + 5], A_reg_0,(16));
  C_reg_5_1 = __riscv_vfmacc_vf_f16m1(C_reg_5_1, B[(k) * (14) + 5], A_reg_1,(16));
  C_reg_5_2 = __riscv_vfmacc_vf_f16m1(C_reg_5_2, B[(k) * (14) + 5], A_reg_2,(16));
  C_reg_5_3 = __riscv_vfmacc_vf_f16m1(C_reg_5_3, B[(k) * (14) + 5], A_reg_3,(16));
  C_reg_6_0 = __riscv_vfmacc_vf_f16m1(C_reg_6_0, B[(k) * (14) + 6], A_reg_0,(16));
  C_reg_6_1 = __riscv_vfmacc_vf_f16m1(C_reg_6_1, B[(k) * (14) + 6], A_reg_1,(16));
  C_reg_6_2 = __riscv_vfmacc_vf_f16m1(C_reg_6_2, B[(k) * (14) + 6], A_reg_2,(16));
  C_reg_6_3 = __riscv_vfmacc_vf_f16m1(C_reg_6_3, B[(k) * (14) + 6], A_reg_3,(16));
  C_reg_7_0 = __riscv_vfmacc_vf_f16m1(C_reg_7_0, B[(k) * (14) + 7], A_reg_0,(16));
  C_reg_7_1 = __riscv_vfmacc_vf_f16m1(C_reg_7_1, B[(k) * (14) + 7], A_reg_1,(16));
  C_reg_7_2 = __riscv_vfmacc_vf_f16m1(C_reg_7_2, B[(k) * (14) + 7], A_reg_2,(16));
  C_reg_7_3 = __riscv_vfmacc_vf_f16m1(C_reg_7_3, B[(k) * (14) + 7], A_reg_3,(16));
  C_reg_8_0 = __riscv_vfmacc_vf_f16m1(C_reg_8_0, B[(k) * (14) + 8], A_reg_0,(16));
  C_reg_8_1 = __riscv_vfmacc_vf_f16m1(C_reg_8_1, B[(k) * (14) + 8], A_reg_1,(16));
  C_reg_8_2 = __riscv_vfmacc_vf_f16m1(C_reg_8_2, B[(k) * (14) + 8], A_reg_2,(16));
  C_reg_8_3 = __riscv_vfmacc_vf_f16m1(C_reg_8_3, B[(k) * (14) + 8], A_reg_3,(16));
  C_reg_9_0 = __riscv_vfmacc_vf_f16m1(C_reg_9_0, B[(k) * (14) + 9], A_reg_0,(16));
  C_reg_9_1 = __riscv_vfmacc_vf_f16m1(C_reg_9_1, B[(k) * (14) + 9], A_reg_1,(16));
  C_reg_9_2 = __riscv_vfmacc_vf_f16m1(C_reg_9_2, B[(k) * (14) + 9], A_reg_2,(16));
  C_reg_9_3 = __riscv_vfmacc_vf_f16m1(C_reg_9_3, B[(k) * (14) + 9], A_reg_3,(16));
  C_reg_10_0 = __riscv_vfmacc_vf_f16m1(C_reg_10_0, B[(k) * (14) + 10], A_reg_0,(16));
  C_reg_10_1 = __riscv_vfmacc_vf_f16m1(C_reg_10_1, B[(k) * (14) + 10], A_reg_1,(16));
  C_reg_10_2 = __riscv_vfmacc_vf_f16m1(C_reg_10_2, B[(k) * (14) + 10], A_reg_2,(16));
  C_reg_10_3 = __riscv_vfmacc_vf_f16m1(C_reg_10_3, B[(k) * (14) + 10], A_reg_3,(16));
  C_reg_11_0 = __riscv_vfmacc_vf_f16m1(C_reg_11_0, B[(k) * (14) + 11], A_reg_0,(16));
  C_reg_11_1 = __riscv_vfmacc_vf_f16m1(C_reg_11_1, B[(k) * (14) + 11], A_reg_1,(16));
  C_reg_11_2 = __riscv_vfmacc_vf_f16m1(C_reg_11_2, B[(k) * (14) + 11], A_reg_2,(16));
  C_reg_11_3 = __riscv_vfmacc_vf_f16m1(C_reg_11_3, B[(k) * (14) + 11], A_reg_3,(16));
  C_reg_12_0 = __riscv_vfmacc_vf_f16m1(C_reg_12_0, B[(k) * (14) + 12], A_reg_0,(16));
  C_reg_12_1 = __riscv_vfmacc_vf_f16m1(C_reg_12_1, B[(k) * (14) + 12], A_reg_1,(16));
  C_reg_12_2 = __riscv_vfmacc_vf_f16m1(C_reg_12_2, B[(k) * (14) + 12], A_reg_2,(16));
  C_reg_12_3 = __riscv_vfmacc_vf_f16m1(C_reg_12_3, B[(k) * (14) + 12], A_reg_3,(16));
  C_reg_13_0 = __riscv_vfmacc_vf_f16m1(C_reg_13_0, B[(k) * (14) + 13], A_reg_0,(16));
  C_reg_13_1 = __riscv_vfmacc_vf_f16m1(C_reg_13_1, B[(k) * (14) + 13], A_reg_1,(16));
  C_reg_13_2 = __riscv_vfmacc_vf_f16m1(C_reg_13_2, B[(k) * (14) + 13], A_reg_2,(16));
  C_reg_13_3 = __riscv_vfmacc_vf_f16m1(C_reg_13_3, B[(k) * (14) + 13], A_reg_3,(16));
}
...
__riscv_vse16_v_f16m1(&C[(10) * (ldc) + 48], C_reg_10_3,(16));
...
__riscv_vse16_v_f16m1(&C[(11) * (ldc) + 48], C_reg_11_3,(16));
...
__riscv_vse16_v_f16m1(&C[(12) * (ldc) + 48], C_reg_12_3,(16));
...
__riscv_vse16_v_f16m1(&C[(13) * (ldc) + 48], C_reg_13_3,(16));
}

// gemm_RVV_64x14_b1_col_fp16(
//     KC : size,
//     alpha : f32[1] @DRAM,
//     A : [f16][KC, 64] @DRAM,
//     B : [f16][KC, 14] @DRAM,
...
//     C : [f16][14, 64] @DRAM
// )
void gemm_RVV_64x14_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
...
C_reg_10_3 = __riscv_vle16_v_f16m1(&C[(10) * (ldc) + 48],(16));
...
C_reg_11_3 = __riscv_vle16_v_f16m1(&C[(11) * (ldc) + 48],(16));
...
C_reg_12_3 = __riscv_vle16_v_f16m1(&C[(12) * (ldc) + 48],(16));
...
C_reg_13_3 = __riscv_vle16_v_f16m1(&C[(13) * (ldc) + 48],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A[(k) * (64)],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A[(k) * (64) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A[(k) * (64) + 32],(16));
