#include "kernels_RVV_96x8_fp16.h"
...
//     C : [f16][8, 96] @DRAM
// )
void gemm_RVV_96x8_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
vfloat16m1_t C_reg_6_4;
vfloat16m1_t C_reg_6_5;
vfloat16m1_t C_reg_7_0;
vfloat16m1_t C_reg_7_1;
vfloat16m1_t C_reg_7_2;
vfloat16m1_t C_reg_7_3;
vfloat16m1_t C_reg_7_4;
vfloat16m1_t C_reg_7_5;
...
C_reg_6_4 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_6_5 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
...
C_reg_7_4 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_7_5 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (8)], A_reg_0,(16));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (8)], A_reg_1,(16));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (8)], A_reg_2,(16));
  C_reg_0_3 = __riscv_vfmacc_vf_f16m1(C_reg_0_3, B[(k) * (8)], A_reg_3,(16));
  C_reg_0_4 = __riscv_vfmacc_vf_f16m1(C_reg_0_4, B[(k) * (8)], A_reg_4,(16));
  C_reg_0_5 = __riscv_vfmacc_vf_f16m1(C_reg_0_5, B[(k) * (8)], A_reg_5,(16));
  C_reg_1_0 = __riscv_vfmacc_vf_f16m1(C_reg_1_0, B[(k) * (8) + 1], A_reg_0,(16));
  C_reg_1_1 = __riscv_vfmacc_vf_f16m1(C_reg_1_1, B[(k) * (8) + 1], A_reg_1,(16));
  C_reg_1_2 = __riscv_vfmacc_vf_f16m1(C_reg_1_2, B[(k) * (8) + 1], A_reg_2,(16));
  C_reg_1_3 = __riscv_vfmacc_vf_f16m1(C_reg_1_3, B[(k) * (8) + 1], A_reg_3,(16));
  C_reg_1_4 = __riscv_vfmacc_vf_f16m1(C_reg_1_4, B[(k) * (8) + 1], A_reg_4,(16));
  C_reg_1_5 = __riscv_vfmacc_vf_f16m1(C_reg_1_5, B[(k) * (8) + 1], A_reg_5,(16));
  C_reg_2_0 = __riscv_vfmacc_vf_f16m1(C_reg_2_0, B[(k) * (8) + 2], A_reg_0,(16));
  C_reg_2_1 = __riscv_vfmacc_vf_f16m1(C_reg_2_1, B[(k) * (8) + 2], A_reg_1,(16));
  C_reg_2_2 = __riscv_vfmacc_vf_f16m1(C_reg_2_2, B[(k) * (8) + 2], A_reg_2,(16));
  C_reg_2_3 = __riscv_vfmacc_vf_f16m1(C_reg_2_3, B[(k) * (8) + 2], A_reg_3,(16));
  C_reg_2_4 = __riscv_vfmacc_vf_f16m1(C_reg_2_4, B[(k) * (8) + 2], A_reg_4,(16));
  C_reg_2_5 = __riscv_vfmacc_vf_f16m1(C_reg_2_5, B[(k) * (8) + 2], A_reg_5,(16));
  C_reg_3_0 = __riscv_vfmacc_vf_f16m1(C_reg_3_0, B[(k) * (8) + 3], A_reg_0,(16));
  C_reg_3_1 = __riscv_vfmacc_vf_f16m1(C_reg_3_1, B[(k) * (8) + 3], A_reg_1,(16));
  C_reg_3_2 = __riscv_vfmacc_vf_f16m1(C_reg_3_2, B[(k) * (8) + 3], A_reg_2,(16));
  C_reg_3_3 = __riscv_vfmacc_vf_f16m1(C_reg_3_3, B[(k) * (8) + 3], A_reg_3,(16));
  C_reg_3_4 = __riscv_vfmacc_vf_f16m1(C_reg_3_4, B[(k) * (8) + 3], A_reg_4,(16));
  C_reg_3_5 = __riscv_vfmacc_vf_f16m1(C_reg_3_5, B[(k) * (8) + 3], A_reg_5,(16));
  C_reg_4_0 = __riscv_vfmacc_vf_f16m1(C_reg_4_0, B[(k) * (8) + 4], A_reg_0,(16));
  C_reg_4_1 = __riscv_vfmacc_vf_f16m1(C_reg_4_1, B[(k) * (8) + 4], A_reg_1,(16));
  C_reg_4_2 = __riscv_vfmacc_vf_f16m1(C_reg_4_2, B[(k) * (8) + 4], A_reg_2,(16));
  C_reg_4_3 = __riscv_vfmacc_vf_f16m1(C_reg_4_3, B[(k) * (8) + 4], A_reg_3,(16));
  C_reg_4_4 = __riscv_vfmacc_vf_f16m1(C_reg_4_4, B[(k) * (8) + 4], A_reg_4,(16));
  C_reg_4_5 = __riscv_vfmacc_vf_f16m1(C_reg_4_5, B[(k) * (8) + 4], A_reg_5,(16));
  C_reg_5_0 = __riscv_vfmacc_vf_f16m1(C_reg_5_0, B[(k) * (8) + 5], A_reg_0,(16));
  C_reg_5_1 = __riscv_vfmacc_vf_f16m1(C_reg_5_1, B[(k) * (8) + 5], A_reg_1,(16));
  C_reg_5_2 = __riscv_vfmacc_vf_f16m1(C_reg_5_2, B[(k) * (8) + 5], A_reg_2,(16));
  C_reg_5_3 = __riscv_vfmacc_vf_f16m1(C_reg_5_3, B[(k) * (8) + 5], A_reg_3,(16));
  C_reg_5_4 = __riscv_vfmacc_vf_f16m1(C_reg_5_4, B[(k) * (8) + 5], A_reg_4,(16));
  C_reg_5_5 = __riscv_vfmacc_vf_f16m1(C_reg_5_5, B[(k) * (8) + 5], A_reg_5,(16));
  C_reg_6_0 = __riscv_vfmacc_vf_f16m1(C_reg_6_0, B[(k) * (8) + 6], A_reg_0,(16));
  C_reg_6_1 = __riscv_vfmacc_vf_f16m1(C_reg_6_1, B[(k) * (8) + 6], A_reg_1,(16));
  C_reg_6_2 = __riscv_vfmacc_vf_f16m1(C_reg_6_2, B[(k) * (8) + 6], A_reg_2,(16));
  C_reg_6_3 = __riscv_vfmacc_vf_f16m1(C_reg_6_3, B[(k) * (8) + 6], A_reg_3,(16));
  C_reg_6_4 = __riscv_vfmacc_vf_f16m1(C_reg_6_4, B[(k) * (8) + 6], A_reg_4,(16));
  C_reg_6_5 = __riscv_vfmacc_vf_f16m1(C_reg_6_5, B[(k) * (8) + 6], A_reg_5,(16));
  C_reg_7_0 = __riscv_vfmacc_vf_f16m1(C_reg_7_0, B[(k) * (8) + 7], A_reg_0,(16));
  C_reg_7_1 = __riscv_vfmacc_vf_f16m1(C_reg_7_1, B[(k) * (8) + 7], A_reg_1,(16));
  C_reg_7_2 = __riscv_vfmacc_vf_f16m1(C_reg_7_2, B[(k) * (8) + 7], A_reg_2,(16));
  C_reg_7_3 = __riscv_vfmacc_vf_f16m1(C_reg_7_3, B[(k) * (8) + 7], A_reg_3,(16));
  C_reg_7_4 = __riscv_vfmacc_vf_f16m1(C_reg_7_4, B[(k) * (8) + 7], A_reg_4,(16));
  C_reg_7_5 = __riscv_vfmacc_vf_f16m1(C_reg_7_5, B[(k) * (8) + 7], A_reg_5,(16));
}
...
__riscv_vse16_v_f16m1(&C[(6) * (ldc) + 64], C_reg_6_4,(16));
__riscv_vse16_v_f16m1(&C[(6) * (ldc) + 80], C_reg_6_5,(16));
...
__riscv_vse16_v_f16m1(&C[(7) * (ldc) + 64], C_reg_7_4,(16));
__riscv_vse16_v_f16m1(&C[(7) * (ldc) + 80], C_reg_7_5,(16));
}

// gemm_RVV_96x8_b1_col_fp16(
//     KC : size,
//     alpha : f32[1] @DRAM,
//     A : [f16][KC, 96] @DRAM,
//     B : [f16][KC, 8] @DRAM,
...
//     C : [f16][8, 96] @DRAM
// )
void gemm_RVV_96x8_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
...
C_reg_6_4 = __riscv_vle16_v_f16m1(&C[(6) * (ldc) + 64],(16));
C_reg_6_5 = __riscv_vle16_v_f16m1(&C[(6) * (ldc) + 80],(16));
...
C_reg_7_4 = __riscv_vle16_v_f16m1(&C[(7) * (ldc) + 64],(16));
C_reg_7_5 = __riscv_vle16_v_f16m1(&C[(7) * (ldc) + 80],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A[(k) * (96)],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A[(k) * (96) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A[(k) * (96) + 32],(16));
