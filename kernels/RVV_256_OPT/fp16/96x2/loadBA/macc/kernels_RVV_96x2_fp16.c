...
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_4 = __riscv_vfmacc_vf_f16m1(C_reg_0_4, B[(k) * (2)], A_reg_4,(16));
  C_reg_0_5 = __riscv_vfmacc_vf_f16m1(C_reg_0_5, B[(k) * (2)], A_reg_5,(16));
  ...
  C_reg_1_4 = __riscv_vfmacc_vf_f16m1(C_reg_1_4, B[(k) * (2) + 1], A_reg_4,(16));
  C_reg_1_5 = __riscv_vfmacc_vf_f16m1(C_reg_1_5, B[(k) * (2) + 1], A_reg_5,(16));
}
