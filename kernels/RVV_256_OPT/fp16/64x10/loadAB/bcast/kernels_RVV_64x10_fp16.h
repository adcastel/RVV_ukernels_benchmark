...
//     C : [f16][10, 49] @DRAM
// )
void gemm_RVV_49x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 49] @DRAM
// )
void gemm_RVV_49x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 49] @DRAM
// )
void gemm_RVV_49x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 49] @DRAM
// )
void gemm_RVV_49x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 50] @DRAM
// )
void gemm_RVV_50x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 50] @DRAM
// )
void gemm_RVV_50x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 50] @DRAM
// )
void gemm_RVV_50x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 50] @DRAM
// )
void gemm_RVV_50x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 51] @DRAM
// )
void gemm_RVV_51x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 51] @DRAM
// )
void gemm_RVV_51x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 51] @DRAM
// )
void gemm_RVV_51x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 51] @DRAM
// )
void gemm_RVV_51x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 52] @DRAM
// )
void gemm_RVV_52x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 52] @DRAM
// )
void gemm_RVV_52x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 52] @DRAM
// )
void gemm_RVV_52x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 52] @DRAM
// )
void gemm_RVV_52x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 53] @DRAM
// )
void gemm_RVV_53x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 53] @DRAM
// )
void gemm_RVV_53x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 53] @DRAM
// )
void gemm_RVV_53x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 53] @DRAM
// )
void gemm_RVV_53x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 54] @DRAM
// )
void gemm_RVV_54x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 54] @DRAM
// )
void gemm_RVV_54x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 54] @DRAM
// )
void gemm_RVV_54x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 54] @DRAM
// )
void gemm_RVV_54x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 55] @DRAM
// )
void gemm_RVV_55x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 55] @DRAM
// )
void gemm_RVV_55x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 55] @DRAM
// )
void gemm_RVV_55x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 55] @DRAM
// )
void gemm_RVV_55x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 56] @DRAM
// )
void gemm_RVV_56x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 56] @DRAM
// )
void gemm_RVV_56x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 56] @DRAM
// )
void gemm_RVV_56x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 56] @DRAM
// )
void gemm_RVV_56x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 57] @DRAM
// )
void gemm_RVV_57x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 57] @DRAM
// )
void gemm_RVV_57x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 57] @DRAM
// )
void gemm_RVV_57x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 57] @DRAM
// )
void gemm_RVV_57x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 58] @DRAM
// )
void gemm_RVV_58x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 58] @DRAM
// )
void gemm_RVV_58x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 58] @DRAM
// )
void gemm_RVV_58x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 58] @DRAM
// )
void gemm_RVV_58x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 59] @DRAM
// )
void gemm_RVV_59x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 59] @DRAM
// )
void gemm_RVV_59x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 59] @DRAM
// )
void gemm_RVV_59x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 59] @DRAM
// )
void gemm_RVV_59x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 60] @DRAM
// )
void gemm_RVV_60x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 60] @DRAM
// )
void gemm_RVV_60x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 60] @DRAM
// )
void gemm_RVV_60x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 60] @DRAM
// )
void gemm_RVV_60x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 61] @DRAM
// )
void gemm_RVV_61x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 61] @DRAM
// )
void gemm_RVV_61x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 61] @DRAM
// )
void gemm_RVV_61x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 61] @DRAM
// )
void gemm_RVV_61x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 62] @DRAM
// )
void gemm_RVV_62x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 62] @DRAM
// )
void gemm_RVV_62x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 62] @DRAM
// )
void gemm_RVV_62x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 62] @DRAM
// )
void gemm_RVV_62x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 63] @DRAM
// )
void gemm_RVV_63x10_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][10, 63] @DRAM
// )
void gemm_RVV_63x10_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 63] @DRAM
// )
void gemm_RVV_63x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 63] @DRAM
// )
void gemm_RVV_63x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 64] @DRAM
// )
void gemm_RVV_64x9_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
...
//     C : [f16][9, 64] @DRAM
// )
void gemm_RVV_64x9_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc );
