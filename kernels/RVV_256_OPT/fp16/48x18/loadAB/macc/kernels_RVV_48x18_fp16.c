#include "kernels_RVV_48x18_fp16.h"
...
//     C : [f16][18, 48] @DRAM
// )
void gemm_RVV_48x18_b0_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
...
vfloat16m1_t C_reg_16_2;
vfloat16m1_t C_reg_17_0;
vfloat16m1_t C_reg_17_1;
vfloat16m1_t C_reg_17_2;
...
C_reg_16_0 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_16_1 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_16_2 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_17_0 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_17_1 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
C_reg_17_2 = __riscv_vfmv_v_f_f16m1(0.0f,(16));
for (int_fast32_t k = 0; k < KC; k++) {
  ...
  C_reg_0_0 = __riscv_vfmacc_vf_f16m1(C_reg_0_0, B[(k) * (18)], A_reg_0,(16));
  C_reg_0_1 = __riscv_vfmacc_vf_f16m1(C_reg_0_1, B[(k) * (18)], A_reg_1,(16));
  C_reg_0_2 = __riscv_vfmacc_vf_f16m1(C_reg_0_2, B[(k) * (18)], A_reg_2,(16));
  C_reg_1_0 = __riscv_vfmacc_vf_f16m1(C_reg_1_0, B[(k) * (18) + 1], A_reg_0,(16));
  C_reg_1_1 = __riscv_vfmacc_vf_f16m1(C_reg_1_1, B[(k) * (18) + 1], A_reg_1,(16));
  C_reg_1_2 = __riscv_vfmacc_vf_f16m1(C_reg_1_2, B[(k) * (18) + 1], A_reg_2,(16));
  C_reg_2_0 = __riscv_vfmacc_vf_f16m1(C_reg_2_0, B[(k) * (18) + 2], A_reg_0,(16));
  C_reg_2_1 = __riscv_vfmacc_vf_f16m1(C_reg_2_1, B[(k) * (18) + 2], A_reg_1,(16));
  C_reg_2_2 = __riscv_vfmacc_vf_f16m1(C_reg_2_2, B[(k) * (18) + 2], A_reg_2,(16));
  C_reg_3_0 = __riscv_vfmacc_vf_f16m1(C_reg_3_0, B[(k) * (18) + 3], A_reg_0,(16));
  C_reg_3_1 = __riscv_vfmacc_vf_f16m1(C_reg_3_1, B[(k) * (18) + 3], A_reg_1,(16));
  C_reg_3_2 = __riscv_vfmacc_vf_f16m1(C_reg_3_2, B[(k) * (18) + 3], A_reg_2,(16));
  C_reg_4_0 = __riscv_vfmacc_vf_f16m1(C_reg_4_0, B[(k) * (18) + 4], A_reg_0,(16));
  C_reg_4_1 = __riscv_vfmacc_vf_f16m1(C_reg_4_1, B[(k) * (18) + 4], A_reg_1,(16));
  C_reg_4_2 = __riscv_vfmacc_vf_f16m1(C_reg_4_2, B[(k) * (18) + 4], A_reg_2,(16));
  C_reg_5_0 = __riscv_vfmacc_vf_f16m1(C_reg_5_0, B[(k) * (18) + 5], A_reg_0,(16));
  C_reg_5_1 = __riscv_vfmacc_vf_f16m1(C_reg_5_1, B[(k) * (18) + 5], A_reg_1,(16));
  C_reg_5_2 = __riscv_vfmacc_vf_f16m1(C_reg_5_2, B[(k) * (18) + 5], A_reg_2,(16));
  C_reg_6_0 = __riscv_vfmacc_vf_f16m1(C_reg_6_0, B[(k) * (18) + 6], A_reg_0,(16));
  C_reg_6_1 = __riscv_vfmacc_vf_f16m1(C_reg_6_1, B[(k) * (18) + 6], A_reg_1,(16));
  C_reg_6_2 = __riscv_vfmacc_vf_f16m1(C_reg_6_2, B[(k) * (18) + 6], A_reg_2,(16));
  C_reg_7_0 = __riscv_vfmacc_vf_f16m1(C_reg_7_0, B[(k) * (18) + 7], A_reg_0,(16));
  C_reg_7_1 = __riscv_vfmacc_vf_f16m1(C_reg_7_1, B[(k) * (18) + 7], A_reg_1,(16));
  C_reg_7_2 = __riscv_vfmacc_vf_f16m1(C_reg_7_2, B[(k) * (18) + 7], A_reg_2,(16));
  C_reg_8_0 = __riscv_vfmacc_vf_f16m1(C_reg_8_0, B[(k) * (18) + 8], A_reg_0,(16));
  C_reg_8_1 = __riscv_vfmacc_vf_f16m1(C_reg_8_1, B[(k) * (18) + 8], A_reg_1,(16));
  C_reg_8_2 = __riscv_vfmacc_vf_f16m1(C_reg_8_2, B[(k) * (18) + 8], A_reg_2,(16));
  C_reg_9_0 = __riscv_vfmacc_vf_f16m1(C_reg_9_0, B[(k) * (18) + 9], A_reg_0,(16));
  C_reg_9_1 = __riscv_vfmacc_vf_f16m1(C_reg_9_1, B[(k) * (18) + 9], A_reg_1,(16));
  C_reg_9_2 = __riscv_vfmacc_vf_f16m1(C_reg_9_2, B[(k) * (18) + 9], A_reg_2,(16));
  C_reg_10_0 = __riscv_vfmacc_vf_f16m1(C_reg_10_0, B[(k) * (18) + 10], A_reg_0,(16));
  C_reg_10_1 = __riscv_vfmacc_vf_f16m1(C_reg_10_1, B[(k) * (18) + 10], A_reg_1,(16));
  C_reg_10_2 = __riscv_vfmacc_vf_f16m1(C_reg_10_2, B[(k) * (18) + 10], A_reg_2,(16));
  C_reg_11_0 = __riscv_vfmacc_vf_f16m1(C_reg_11_0, B[(k) * (18) + 11], A_reg_0,(16));
  C_reg_11_1 = __riscv_vfmacc_vf_f16m1(C_reg_11_1, B[(k) * (18) + 11], A_reg_1,(16));
  C_reg_11_2 = __riscv_vfmacc_vf_f16m1(C_reg_11_2, B[(k) * (18) + 11], A_reg_2,(16));
  C_reg_12_0 = __riscv_vfmacc_vf_f16m1(C_reg_12_0, B[(k) * (18) + 12], A_reg_0,(16));
  C_reg_12_1 = __riscv_vfmacc_vf_f16m1(C_reg_12_1, B[(k) * (18) + 12], A_reg_1,(16));
  C_reg_12_2 = __riscv_vfmacc_vf_f16m1(C_reg_12_2, B[(k) * (18) + 12], A_reg_2,(16));
  C_reg_13_0 = __riscv_vfmacc_vf_f16m1(C_reg_13_0, B[(k) * (18) + 13], A_reg_0,(16));
  C_reg_13_1 = __riscv_vfmacc_vf_f16m1(C_reg_13_1, B[(k) * (18) + 13], A_reg_1,(16));
  C_reg_13_2 = __riscv_vfmacc_vf_f16m1(C_reg_13_2, B[(k) * (18) + 13], A_reg_2,(16));
  C_reg_14_0 = __riscv_vfmacc_vf_f16m1(C_reg_14_0, B[(k) * (18) + 14], A_reg_0,(16));
  C_reg_14_1 = __riscv_vfmacc_vf_f16m1(C_reg_14_1, B[(k) * (18) + 14], A_reg_1,(16));
  C_reg_14_2 = __riscv_vfmacc_vf_f16m1(C_reg_14_2, B[(k) * (18) + 14], A_reg_2,(16));
  C_reg_15_0 = __riscv_vfmacc_vf_f16m1(C_reg_15_0, B[(k) * (18) + 15], A_reg_0,(16));
  C_reg_15_1 = __riscv_vfmacc_vf_f16m1(C_reg_15_1, B[(k) * (18) + 15], A_reg_1,(16));
  C_reg_15_2 = __riscv_vfmacc_vf_f16m1(C_reg_15_2, B[(k) * (18) + 15], A_reg_2,(16));
  C_reg_16_0 = __riscv_vfmacc_vf_f16m1(C_reg_16_0, B[(k) * (18) + 16], A_reg_0,(16));
  C_reg_16_1 = __riscv_vfmacc_vf_f16m1(C_reg_16_1, B[(k) * (18) + 16], A_reg_1,(16));
  C_reg_16_2 = __riscv_vfmacc_vf_f16m1(C_reg_16_2, B[(k) * (18) + 16], A_reg_2,(16));
  C_reg_17_0 = __riscv_vfmacc_vf_f16m1(C_reg_17_0, B[(k) * (18) + 17], A_reg_0,(16));
  C_reg_17_1 = __riscv_vfmacc_vf_f16m1(C_reg_17_1, B[(k) * (18) + 17], A_reg_1,(16));
  C_reg_17_2 = __riscv_vfmacc_vf_f16m1(C_reg_17_2, B[(k) * (18) + 17], A_reg_2,(16));
}
...
__riscv_vse16_v_f16m1(&C[(16) * (ldc)], C_reg_16_0,(16));
__riscv_vse16_v_f16m1(&C[(16) * (ldc) + 16], C_reg_16_1,(16));
__riscv_vse16_v_f16m1(&C[(16) * (ldc) + 32], C_reg_16_2,(16));
__riscv_vse16_v_f16m1(&C[(17) * (ldc)], C_reg_17_0,(16));
__riscv_vse16_v_f16m1(&C[(17) * (ldc) + 16], C_reg_17_1,(16));
__riscv_vse16_v_f16m1(&C[(17) * (ldc) + 32], C_reg_17_2,(16));
}

// gemm_RVV_48x18_b1_col_fp16(
//     KC : size,
//     alpha : f32[1] @DRAM,
//     A : [f16][KC, 48] @DRAM,
//     B : [f16][KC, 18] @DRAM,
...
//     C : [f16][18, 48] @DRAM
// )
void gemm_RVV_48x18_b1_col_fp16( void *ctxt, int_fast32_t KC, const float* alpha, _Float16 * A, int lda, _Float16 * B, int ldb, const float* beta, _Float16 C, int ldc ) {
// assert stride(A, 1) == 1
// assert stride(B, 1) == 1
// assert stride(C, 1) == 1
vfloat16m1_t A_reg_0;
...
C_reg_16_0 = __riscv_vle16_v_f16m1(&C[(16) * (ldc)],(16));
C_reg_16_1 = __riscv_vle16_v_f16m1(&C[(16) * (ldc) + 16],(16));
C_reg_16_2 = __riscv_vle16_v_f16m1(&C[(16) * (ldc) + 32],(16));
C_reg_17_0 = __riscv_vle16_v_f16m1(&C[(17) * (ldc)],(16));
C_reg_17_1 = __riscv_vle16_v_f16m1(&C[(17) * (ldc) + 16],(16));
C_reg_17_2 = __riscv_vle16_v_f16m1(&C[(17) * (ldc) + 32],(16));
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = __riscv_vle16_v_f16m1(&A[(k) * (48)],(16));
  A_reg_1 = __riscv_vle16_v_f16m1(&A[(k) * (48) + 16],(16));
  A_reg_2 = __riscv_vle16_v_f16m1(&A[(k) * (48) + 32],(16));
