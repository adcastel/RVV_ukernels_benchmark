...
//     C : [f32][10, 33] @DRAM
// )
void gemm_RVV_33x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 33] @DRAM
// )
void gemm_RVV_33x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 33] @DRAM
// )
void gemm_RVV_33x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 33] @DRAM
// )
void gemm_RVV_33x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 34] @DRAM
// )
void gemm_RVV_34x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 34] @DRAM
// )
void gemm_RVV_34x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 34] @DRAM
// )
void gemm_RVV_34x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 34] @DRAM
// )
void gemm_RVV_34x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 35] @DRAM
// )
void gemm_RVV_35x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 35] @DRAM
// )
void gemm_RVV_35x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 35] @DRAM
// )
void gemm_RVV_35x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 35] @DRAM
// )
void gemm_RVV_35x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 36] @DRAM
// )
void gemm_RVV_36x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 36] @DRAM
// )
void gemm_RVV_36x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 36] @DRAM
// )
void gemm_RVV_36x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 36] @DRAM
// )
void gemm_RVV_36x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 37] @DRAM
// )
void gemm_RVV_37x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 37] @DRAM
// )
void gemm_RVV_37x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 37] @DRAM
// )
void gemm_RVV_37x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 37] @DRAM
// )
void gemm_RVV_37x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 38] @DRAM
// )
void gemm_RVV_38x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 38] @DRAM
// )
void gemm_RVV_38x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 38] @DRAM
// )
void gemm_RVV_38x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 38] @DRAM
// )
void gemm_RVV_38x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 39] @DRAM
// )
void gemm_RVV_39x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 39] @DRAM
// )
void gemm_RVV_39x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 39] @DRAM
// )
void gemm_RVV_39x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 39] @DRAM
// )
void gemm_RVV_39x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 40] @DRAM
// )
void gemm_RVV_40x10_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][10, 40] @DRAM
// )
void gemm_RVV_40x10_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 40] @DRAM
// )
void gemm_RVV_40x9_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][9, 40] @DRAM
// )
void gemm_RVV_40x9_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
