...
#pragma once
#ifndef KERNELS_RVV_48X8_FP32_H
#define KERNELS_RVV_48X8_FP32_H
...
//     C : [f32][8, 33] @DRAM
// )
void gemm_RVV_33x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 33] @DRAM
// )
void gemm_RVV_33x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 34] @DRAM
// )
void gemm_RVV_34x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 34] @DRAM
// )
void gemm_RVV_34x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 35] @DRAM
// )
void gemm_RVV_35x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 35] @DRAM
// )
void gemm_RVV_35x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 36] @DRAM
// )
void gemm_RVV_36x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 36] @DRAM
// )
void gemm_RVV_36x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 37] @DRAM
// )
void gemm_RVV_37x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 37] @DRAM
// )
void gemm_RVV_37x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 38] @DRAM
// )
void gemm_RVV_38x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 38] @DRAM
// )
void gemm_RVV_38x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 39] @DRAM
// )
void gemm_RVV_39x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 39] @DRAM
// )
void gemm_RVV_39x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 40] @DRAM
// )
void gemm_RVV_40x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 40] @DRAM
// )
void gemm_RVV_40x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 41] @DRAM
// )
void gemm_RVV_41x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 41] @DRAM
// )
void gemm_RVV_41x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 41] @DRAM
// )
void gemm_RVV_41x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 41] @DRAM
// )
void gemm_RVV_41x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 41] @DRAM
// )
void gemm_RVV_41x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 41] @DRAM
// )
void gemm_RVV_41x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 42] @DRAM
// )
void gemm_RVV_42x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 42] @DRAM
// )
void gemm_RVV_42x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 42] @DRAM
// )
void gemm_RVV_42x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 42] @DRAM
// )
void gemm_RVV_42x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 42] @DRAM
// )
void gemm_RVV_42x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 42] @DRAM
// )
void gemm_RVV_42x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 43] @DRAM
// )
void gemm_RVV_43x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 43] @DRAM
// )
void gemm_RVV_43x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 43] @DRAM
// )
void gemm_RVV_43x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 43] @DRAM
// )
void gemm_RVV_43x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 43] @DRAM
// )
void gemm_RVV_43x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 43] @DRAM
// )
void gemm_RVV_43x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 44] @DRAM
// )
void gemm_RVV_44x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 44] @DRAM
// )
void gemm_RVV_44x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 44] @DRAM
// )
void gemm_RVV_44x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 44] @DRAM
// )
void gemm_RVV_44x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 44] @DRAM
// )
void gemm_RVV_44x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 44] @DRAM
// )
void gemm_RVV_44x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 45] @DRAM
// )
void gemm_RVV_45x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 45] @DRAM
// )
void gemm_RVV_45x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 45] @DRAM
// )
void gemm_RVV_45x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 45] @DRAM
// )
void gemm_RVV_45x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 45] @DRAM
// )
void gemm_RVV_45x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 45] @DRAM
// )
void gemm_RVV_45x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 46] @DRAM
// )
void gemm_RVV_46x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 46] @DRAM
// )
void gemm_RVV_46x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 46] @DRAM
// )
void gemm_RVV_46x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 46] @DRAM
// )
void gemm_RVV_46x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 46] @DRAM
// )
void gemm_RVV_46x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 46] @DRAM
// )
void gemm_RVV_46x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 47] @DRAM
// )
void gemm_RVV_47x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 47] @DRAM
// )
void gemm_RVV_47x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 47] @DRAM
// )
void gemm_RVV_47x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 47] @DRAM
// )
void gemm_RVV_47x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 47] @DRAM
// )
void gemm_RVV_47x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 47] @DRAM
// )
void gemm_RVV_47x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 48] @DRAM
// )
void gemm_RVV_48x6_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][6, 48] @DRAM
// )
void gemm_RVV_48x6_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 48] @DRAM
// )
void gemm_RVV_48x7_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][7, 48] @DRAM
// )
void gemm_RVV_48x7_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 48] @DRAM
// )
void gemm_RVV_48x8_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][8, 48] @DRAM
// )
void gemm_RVV_48x8_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
