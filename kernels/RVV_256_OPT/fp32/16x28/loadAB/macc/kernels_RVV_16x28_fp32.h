...
//     C : [f32][20, 10] @DRAM
// )
void gemm_RVV_10x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 10] @DRAM
// )
void gemm_RVV_10x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 10] @DRAM
// )
void gemm_RVV_10x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 10] @DRAM
// )
void gemm_RVV_10x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 10] @DRAM
// )
void gemm_RVV_10x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 10] @DRAM
// )
void gemm_RVV_10x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 10] @DRAM
// )
void gemm_RVV_10x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 10] @DRAM
// )
void gemm_RVV_10x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 10] @DRAM
// )
void gemm_RVV_10x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 10] @DRAM
// )
void gemm_RVV_10x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 10] @DRAM
// )
void gemm_RVV_10x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 10] @DRAM
// )
void gemm_RVV_10x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 10] @DRAM
// )
void gemm_RVV_10x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 10] @DRAM
// )
void gemm_RVV_10x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 10] @DRAM
// )
void gemm_RVV_10x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 10] @DRAM
// )
void gemm_RVV_10x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 10] @DRAM
// )
void gemm_RVV_10x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 10] @DRAM
// )
void gemm_RVV_10x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 11] @DRAM
// )
void gemm_RVV_11x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 11] @DRAM
// )
void gemm_RVV_11x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 11] @DRAM
// )
void gemm_RVV_11x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 11] @DRAM
// )
void gemm_RVV_11x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 11] @DRAM
// )
void gemm_RVV_11x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 11] @DRAM
// )
void gemm_RVV_11x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 11] @DRAM
// )
void gemm_RVV_11x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 11] @DRAM
// )
void gemm_RVV_11x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 11] @DRAM
// )
void gemm_RVV_11x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 11] @DRAM
// )
void gemm_RVV_11x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 11] @DRAM
// )
void gemm_RVV_11x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 11] @DRAM
// )
void gemm_RVV_11x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 11] @DRAM
// )
void gemm_RVV_11x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 11] @DRAM
// )
void gemm_RVV_11x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 11] @DRAM
// )
void gemm_RVV_11x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 11] @DRAM
// )
void gemm_RVV_11x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 11] @DRAM
// )
void gemm_RVV_11x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 11] @DRAM
// )
void gemm_RVV_11x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 12] @DRAM
// )
void gemm_RVV_12x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 12] @DRAM
// )
void gemm_RVV_12x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 12] @DRAM
// )
void gemm_RVV_12x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 12] @DRAM
// )
void gemm_RVV_12x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 12] @DRAM
// )
void gemm_RVV_12x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 12] @DRAM
// )
void gemm_RVV_12x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 12] @DRAM
// )
void gemm_RVV_12x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 12] @DRAM
// )
void gemm_RVV_12x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 12] @DRAM
// )
void gemm_RVV_12x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 12] @DRAM
// )
void gemm_RVV_12x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 12] @DRAM
// )
void gemm_RVV_12x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 12] @DRAM
// )
void gemm_RVV_12x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 12] @DRAM
// )
void gemm_RVV_12x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 12] @DRAM
// )
void gemm_RVV_12x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 12] @DRAM
// )
void gemm_RVV_12x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 12] @DRAM
// )
void gemm_RVV_12x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 12] @DRAM
// )
void gemm_RVV_12x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 12] @DRAM
// )
void gemm_RVV_12x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 13] @DRAM
// )
void gemm_RVV_13x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 13] @DRAM
// )
void gemm_RVV_13x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 13] @DRAM
// )
void gemm_RVV_13x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 13] @DRAM
// )
void gemm_RVV_13x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 13] @DRAM
// )
void gemm_RVV_13x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 13] @DRAM
// )
void gemm_RVV_13x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 13] @DRAM
// )
void gemm_RVV_13x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 13] @DRAM
// )
void gemm_RVV_13x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 13] @DRAM
// )
void gemm_RVV_13x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 13] @DRAM
// )
void gemm_RVV_13x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 13] @DRAM
// )
void gemm_RVV_13x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 13] @DRAM
// )
void gemm_RVV_13x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 13] @DRAM
// )
void gemm_RVV_13x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 13] @DRAM
// )
void gemm_RVV_13x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 13] @DRAM
// )
void gemm_RVV_13x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 13] @DRAM
// )
void gemm_RVV_13x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 13] @DRAM
// )
void gemm_RVV_13x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 13] @DRAM
// )
void gemm_RVV_13x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 14] @DRAM
// )
void gemm_RVV_14x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 14] @DRAM
// )
void gemm_RVV_14x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 14] @DRAM
// )
void gemm_RVV_14x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 14] @DRAM
// )
void gemm_RVV_14x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 14] @DRAM
// )
void gemm_RVV_14x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 14] @DRAM
// )
void gemm_RVV_14x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 14] @DRAM
// )
void gemm_RVV_14x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 14] @DRAM
// )
void gemm_RVV_14x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 14] @DRAM
// )
void gemm_RVV_14x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 14] @DRAM
// )
void gemm_RVV_14x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 14] @DRAM
// )
void gemm_RVV_14x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 14] @DRAM
// )
void gemm_RVV_14x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 14] @DRAM
// )
void gemm_RVV_14x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 14] @DRAM
// )
void gemm_RVV_14x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 14] @DRAM
// )
void gemm_RVV_14x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 14] @DRAM
// )
void gemm_RVV_14x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 14] @DRAM
// )
void gemm_RVV_14x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 14] @DRAM
// )
void gemm_RVV_14x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 15] @DRAM
// )
void gemm_RVV_15x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 15] @DRAM
// )
void gemm_RVV_15x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 15] @DRAM
// )
void gemm_RVV_15x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 15] @DRAM
// )
void gemm_RVV_15x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 15] @DRAM
// )
void gemm_RVV_15x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 15] @DRAM
// )
void gemm_RVV_15x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 15] @DRAM
// )
void gemm_RVV_15x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 15] @DRAM
// )
void gemm_RVV_15x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 15] @DRAM
// )
void gemm_RVV_15x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 15] @DRAM
// )
void gemm_RVV_15x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 15] @DRAM
// )
void gemm_RVV_15x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 15] @DRAM
// )
void gemm_RVV_15x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 15] @DRAM
// )
void gemm_RVV_15x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 15] @DRAM
// )
void gemm_RVV_15x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 15] @DRAM
// )
void gemm_RVV_15x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 15] @DRAM
// )
void gemm_RVV_15x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 15] @DRAM
// )
void gemm_RVV_15x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 15] @DRAM
// )
void gemm_RVV_15x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 16] @DRAM
// )
void gemm_RVV_16x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 16] @DRAM
// )
void gemm_RVV_16x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 16] @DRAM
// )
void gemm_RVV_16x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 16] @DRAM
// )
void gemm_RVV_16x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 16] @DRAM
// )
void gemm_RVV_16x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 16] @DRAM
// )
void gemm_RVV_16x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 16] @DRAM
// )
void gemm_RVV_16x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 16] @DRAM
// )
void gemm_RVV_16x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 16] @DRAM
// )
void gemm_RVV_16x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 16] @DRAM
// )
void gemm_RVV_16x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 16] @DRAM
// )
void gemm_RVV_16x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 16] @DRAM
// )
void gemm_RVV_16x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 16] @DRAM
// )
void gemm_RVV_16x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 16] @DRAM
// )
void gemm_RVV_16x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 16] @DRAM
// )
void gemm_RVV_16x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 16] @DRAM
// )
void gemm_RVV_16x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 16] @DRAM
// )
void gemm_RVV_16x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 16] @DRAM
// )
void gemm_RVV_16x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 9] @DRAM
// )
void gemm_RVV_9x20_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][20, 9] @DRAM
// )
void gemm_RVV_9x20_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 9] @DRAM
// )
void gemm_RVV_9x21_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][21, 9] @DRAM
// )
void gemm_RVV_9x21_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 9] @DRAM
// )
void gemm_RVV_9x22_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][22, 9] @DRAM
// )
void gemm_RVV_9x22_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 9] @DRAM
// )
void gemm_RVV_9x23_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][23, 9] @DRAM
// )
void gemm_RVV_9x23_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 9] @DRAM
// )
void gemm_RVV_9x24_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][24, 9] @DRAM
// )
void gemm_RVV_9x24_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 9] @DRAM
// )
void gemm_RVV_9x25_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][25, 9] @DRAM
// )
void gemm_RVV_9x25_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 9] @DRAM
// )
void gemm_RVV_9x26_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][26, 9] @DRAM
// )
void gemm_RVV_9x26_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 9] @DRAM
// )
void gemm_RVV_9x27_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][27, 9] @DRAM
// )
void gemm_RVV_9x27_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 9] @DRAM
// )
void gemm_RVV_9x28_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][28, 9] @DRAM
// )
void gemm_RVV_9x28_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
