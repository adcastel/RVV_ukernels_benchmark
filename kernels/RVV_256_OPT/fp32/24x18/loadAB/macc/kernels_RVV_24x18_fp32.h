...
//     C : [f32][13, 17] @DRAM
// )
void gemm_RVV_17x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 17] @DRAM
// )
void gemm_RVV_17x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 17] @DRAM
// )
void gemm_RVV_17x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 17] @DRAM
// )
void gemm_RVV_17x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 17] @DRAM
// )
void gemm_RVV_17x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 17] @DRAM
// )
void gemm_RVV_17x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 17] @DRAM
// )
void gemm_RVV_17x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 17] @DRAM
// )
void gemm_RVV_17x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 17] @DRAM
// )
void gemm_RVV_17x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 17] @DRAM
// )
void gemm_RVV_17x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 17] @DRAM
// )
void gemm_RVV_17x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 17] @DRAM
// )
void gemm_RVV_17x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 18] @DRAM
// )
void gemm_RVV_18x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 18] @DRAM
// )
void gemm_RVV_18x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 18] @DRAM
// )
void gemm_RVV_18x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 18] @DRAM
// )
void gemm_RVV_18x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 18] @DRAM
// )
void gemm_RVV_18x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 18] @DRAM
// )
void gemm_RVV_18x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 18] @DRAM
// )
void gemm_RVV_18x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 18] @DRAM
// )
void gemm_RVV_18x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 18] @DRAM
// )
void gemm_RVV_18x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 18] @DRAM
// )
void gemm_RVV_18x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 18] @DRAM
// )
void gemm_RVV_18x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 18] @DRAM
// )
void gemm_RVV_18x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 19] @DRAM
// )
void gemm_RVV_19x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 19] @DRAM
// )
void gemm_RVV_19x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 19] @DRAM
// )
void gemm_RVV_19x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 19] @DRAM
// )
void gemm_RVV_19x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 19] @DRAM
// )
void gemm_RVV_19x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 19] @DRAM
// )
void gemm_RVV_19x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 19] @DRAM
// )
void gemm_RVV_19x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 19] @DRAM
// )
void gemm_RVV_19x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 19] @DRAM
// )
void gemm_RVV_19x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 19] @DRAM
// )
void gemm_RVV_19x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 19] @DRAM
// )
void gemm_RVV_19x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 19] @DRAM
// )
void gemm_RVV_19x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 20] @DRAM
// )
void gemm_RVV_20x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 20] @DRAM
// )
void gemm_RVV_20x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 20] @DRAM
// )
void gemm_RVV_20x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 20] @DRAM
// )
void gemm_RVV_20x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 20] @DRAM
// )
void gemm_RVV_20x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 20] @DRAM
// )
void gemm_RVV_20x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 20] @DRAM
// )
void gemm_RVV_20x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 20] @DRAM
// )
void gemm_RVV_20x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 20] @DRAM
// )
void gemm_RVV_20x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 20] @DRAM
// )
void gemm_RVV_20x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 20] @DRAM
// )
void gemm_RVV_20x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 20] @DRAM
// )
void gemm_RVV_20x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 21] @DRAM
// )
void gemm_RVV_21x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 21] @DRAM
// )
void gemm_RVV_21x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 21] @DRAM
// )
void gemm_RVV_21x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 21] @DRAM
// )
void gemm_RVV_21x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 21] @DRAM
// )
void gemm_RVV_21x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 21] @DRAM
// )
void gemm_RVV_21x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 21] @DRAM
// )
void gemm_RVV_21x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 21] @DRAM
// )
void gemm_RVV_21x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 21] @DRAM
// )
void gemm_RVV_21x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 21] @DRAM
// )
void gemm_RVV_21x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 21] @DRAM
// )
void gemm_RVV_21x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 21] @DRAM
// )
void gemm_RVV_21x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 22] @DRAM
// )
void gemm_RVV_22x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 22] @DRAM
// )
void gemm_RVV_22x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 22] @DRAM
// )
void gemm_RVV_22x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 22] @DRAM
// )
void gemm_RVV_22x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 22] @DRAM
// )
void gemm_RVV_22x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 22] @DRAM
// )
void gemm_RVV_22x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 22] @DRAM
// )
void gemm_RVV_22x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 22] @DRAM
// )
void gemm_RVV_22x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 22] @DRAM
// )
void gemm_RVV_22x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 22] @DRAM
// )
void gemm_RVV_22x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 22] @DRAM
// )
void gemm_RVV_22x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 22] @DRAM
// )
void gemm_RVV_22x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 23] @DRAM
// )
void gemm_RVV_23x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 23] @DRAM
// )
void gemm_RVV_23x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 23] @DRAM
// )
void gemm_RVV_23x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 23] @DRAM
// )
void gemm_RVV_23x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 23] @DRAM
// )
void gemm_RVV_23x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 23] @DRAM
// )
void gemm_RVV_23x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 23] @DRAM
// )
void gemm_RVV_23x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 23] @DRAM
// )
void gemm_RVV_23x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 23] @DRAM
// )
void gemm_RVV_23x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 23] @DRAM
// )
void gemm_RVV_23x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 23] @DRAM
// )
void gemm_RVV_23x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 23] @DRAM
// )
void gemm_RVV_23x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 24] @DRAM
// )
void gemm_RVV_24x13_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][13, 24] @DRAM
// )
void gemm_RVV_24x13_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 24] @DRAM
// )
void gemm_RVV_24x14_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][14, 24] @DRAM
// )
void gemm_RVV_24x14_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 24] @DRAM
// )
void gemm_RVV_24x15_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][15, 24] @DRAM
// )
void gemm_RVV_24x15_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 24] @DRAM
// )
void gemm_RVV_24x16_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][16, 24] @DRAM
// )
void gemm_RVV_24x16_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 24] @DRAM
// )
void gemm_RVV_24x17_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][17, 24] @DRAM
// )
void gemm_RVV_24x17_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 24] @DRAM
// )
void gemm_RVV_24x18_b0_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
...
//     C : [f32][18, 24] @DRAM
// )
void gemm_RVV_24x18_b1_col_fp32( void *ctxt, int_fast32_t KC, const float* alpha, float * A, int lda, float * B, int ldb, const float* beta, float * C, int ldc );
